...
import '../module_captain/ui/screen/captain_activity_details_screen.dart'
    as _i223;
import '../module_captain/ui/screen/captain_activity_model.dart' as _i232;
import '../module_captain/ui/screen/captain_finance_daily_screen.dart' as _i228;
...
import '../module_captain/ui/screen/captain_financial_dues_screen.dart'
    as _i230;
import '../module_captain/ui/screen/captain_needs_support_screen.dart' as _i233;
import '../module_captain/ui/screen/captain_profile_screen.dart' as _i231;
import '../module_captain/ui/screen/captain_rating_screen.dart' as _i234;
import '../module_captain/ui/screen/captains_assign_order_screen.dart' as _i224;
...
import '../module_captain/ui/screen/change_captain_plan_screen.dart' as _i198;
import '../module_captain/ui/screen/in_active_captains_screen.dart' as _i175;
...
import '../module_categories/ui/screen/packages_screen.dart' as _i196;
import '../module_chat/chat_module.dart' as _i237;
...
import '../module_company/state_manager/company_profile_state_manager.dart'
    as _i168;
import '../module_company/ui/screen/company_finance_screen.dart' as _i238;
import '../module_company/ui/screen/company_profile_screen.dart' as _i239;
import '../module_deep_links/repository/deep_link_repository.dart' as _i33;
import '../module_delivary_car/cars_module.dart' as _i235;
...
import '../module_dev/dev_module.dart' as _i242;
...
import '../module_external_delivery_companies/external_delivery_companies_module.dart'
    as _i244;
import '../module_external_delivery_companies/manager/module_external_delivery_companies_manager.dart'
    as _i81;
import '../module_external_delivery_companies/repository/module_external_delivery_companies_repository.dart'
    as _i35;
import '../module_external_delivery_companies/service/module_external_delivery_companies_service.dart'
    as _i82;
...
import '../module_my_notifications/ui/screen/my_notifications_screen.dart'
    as _i179;
import '../module_my_notifications/ui/screen/update_screen.dart' as _i220;
...
import '../module_orders/ui/screens/order_cash_store_screen.dart' as _i193;
import '../module_orders/ui/screens/order_conflict_distance_screen.dart'
    as _i187;
import '../module_orders/ui/screens/order_logs_screen.dart' as _i188;
import '../module_orders/ui/screens/order_pending_screen.dart' as _i190;
import '../module_orders/ui/screens/orders_captain_screen.dart' as _i185;
import '../module_orders/ui/screens/orders_receive_cash_screen.dart' as _i194;
...
import '../module_payments/state_manager/store_balance_state_manager.dart'
    as _i125;
import '../module_payments/ui/screen/all_amount_captains_screen.dart' as _i221;
...
import '../module_payments/ui/screen/payment_to_captain_screen.dart' as _i197;
import '../module_payments/ui/screen/store_balance_screen.dart' as _i200;
...
import '../module_statistics/state_manager/statistics_state_manager.dart'
    as _i124;
import '../module_statistics/ui/screen/statistics_screen.dart' as _i199;
...
import '../module_stores/state_manager/order/order_time_line_state_manager.dart'
    as _i192;
import '../module_stores/state_manager/store_dues_state_manager.dart' as _i201;
import '../module_stores/state_manager/store_profile_state_manager.dart'
    as _i203;
import '../module_stores/state_manager/stores_dues_state_manager.dart' as _i208;
...
import '../module_stores/ui/screen/order/order_top_active_store.dart' as _i195;
...
import '../module_stores/ui/screen/stores_screen.dart' as _i211;
...
import '../module_supplier/ui/screen/supplier_list_screen.dart' as _i218;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i171.EditSubscriptionStateManager>(() =>
      _i171.EditSubscriptionStateManager(gh<_i131.SubscriptionsService>()));
  gh.factory<_i172.ExternalDeliveryCompaniesScreen>(() =>
      _i172.ExternalDeliveryCompaniesScreen(
          gh<_i83.ExternalDeliveryCompaniesStateManager>()));
  gh.factory<_i173.FilterOrderTopStateManager>(
      () => _i173.FilterOrderTopStateManager(gh<_i127.StoresService>()));
  gh.factory<_i174.HomeScreen>(
      () => _i174.HomeScreen(gh<_i88.HomeStateManager>()));
  gh.factory<_i175.InActiveCaptainsScreen>(() =>
      _i175.InActiveCaptainsScreen(gh<_i89.InActiveCaptainsStateManager>()));
  gh.factory<_i176.InActiveSupplierStateManager>(
      () => _i176.InActiveSupplierStateManager(gh<_i135.SupplierService>()));
  gh.factory<_i177.InitBranchesStateManager>(
      () => _i177.InitBranchesStateManager(gh<_i145.BranchesListService>()));
  gh.factory<_i178.InitSubscriptionStateManager>(() =>
      _i178.InitSubscriptionStateManager(gh<_i131.SubscriptionsService>()));
  gh.factory<_i179.MyNotificationsScreen>(() =>
      _i179.MyNotificationsScreen(gh<_i93.MyNotificationsStateManager>()));
  gh.factory<_i180.NewOrderLinkScreen>(
      () => _i180.NewOrderLinkScreen(gh<_i94.NewOrderLinkStateManager>()));
  gh.factory<_i181.NewOrderScreen>(
      () => _i181.NewOrderScreen(gh<_i95.NewOrderStateManager>()));
  gh.factory<_i182.NewTestOrderScreen>(
      () => _i182.NewTestOrderScreen(gh<_i96.NewTestOrderStateManager>()));
  gh.factory<_i183.NoticeScreen>(
      () => _i183.NoticeScreen(gh<_i99.NoticeStateManager>()));
  gh.factory<_i184.OrderActionLogsScreen>(() =>
      _i184.OrderActionLogsScreen(gh<_i100.OrderActionLogsStateManager>()));
  gh.factory<_i185.OrderCaptainLogsScreen>(() =>
      _i185.OrderCaptainLogsScreen(gh<_i101.OrderCaptainLogsStateManager>()));
  gh.factory<_i186.OrderCaptainNotArrivedStateManager>(() =>
      _i186.OrderCaptainNotArrivedStateManager(gh<_i127.StoresService>()));
  gh.factory<_i187.OrderDistanceConflictScreen>(() =>
      _i187.OrderDistanceConflictScreen(
          gh<_i103.OrderDistanceConflictStateManager>()));
  gh.factory<_i188.OrderLogsScreen>(
      () => _i188.OrderLogsScreen(gh<_i104.OrderLogsStateManager>()));
  gh.factory<_i189.OrderLogsStateManager>(
      () => _i189.OrderLogsStateManager(gh<_i127.StoresService>()));
  gh.factory<_i190.OrderPendingScreen>(
      () => _i190.OrderPendingScreen(gh<_i105.OrderPendingStateManager>()));
  gh.factory<_i191.OrderStatusStateManager>(
      () => _i191.OrderStatusStateManager(gh<_i127.StoresService>()));
  gh.factory<_i192.OrderTimeLineStateManager>(
      () => _i192.OrderTimeLineStateManager(gh<_i127.StoresService>()));
  gh.factory<_i193.OrdersCashStoreScreen>(() =>
      _i193.OrdersCashStoreScreen(gh<_i108.OrdersCashStoreStateManager>()));
  gh.factory<_i194.OrdersReceiveCashScreen>(() =>
      _i194.OrdersReceiveCashScreen(gh<_i109.OrdersReceiveCashStateManager>()));
  gh.factory<_i195.OrdersTopActiveStoreScreen>(() =>
      _i195.OrdersTopActiveStoreScreen(gh<_i173.FilterOrderTopStateManager>()));
  gh.factory<_i196.PackagesScreen>(
      () => _i196.PackagesScreen(gh<_i112.PackagesStateManager>()));
  gh.factory<_i197.PaymentsToCaptainScreen>(() =>
      _i197.PaymentsToCaptainScreen(gh<_i115.PaymentsToCaptainStateManager>()));
  gh.factory<_i198.PlanScreen>(
      () => _i198.PlanScreen(gh<_i116.PlanScreenStateManager>()));
  gh.factory<_i199.StatisticsScreen>(
      () => _i199.StatisticsScreen(gh<_i124.StatisticsStateManager>()));
  gh.factory<_i200.StoreBalanceScreen>(
      () => _i200.StoreBalanceScreen(gh<_i125.StoreBalanceStateManager>()));
  gh.factory<_i201.StoreDuesStateManager>(() => _i201.StoreDuesStateManager(
        gh<_i127.StoresService>(),
        gh<_i114.PaymentsService>(),
      ));
  gh.factory<_i202.StoreFinancialSubscriptionsDuesDetailsStateManager>(
      () => _i202.StoreFinancialSubscriptionsDuesDetailsStateManager(
            gh<_i114.PaymentsService>(),
            gh<_i131.SubscriptionsService>(),
          ));
  gh.factory<_i203.StoreProfileStateManager>(
      () => _i203.StoreProfileStateManager(
            gh<_i127.StoresService>(),
            gh<_i38.ImageUploadService>(),
          ));
  gh.factory<_i204.StoreSubscriptionManagementStateManager>(() =>
      _i204.StoreSubscriptionManagementStateManager(
          gh<_i131.SubscriptionsService>()));
  gh.factory<_i205.StoreSubscriptionsExpiredFinanceStateManager>(() =>
      _i205.StoreSubscriptionsExpiredFinanceStateManager(
          gh<_i131.SubscriptionsService>()));
  gh.factory<_i206.StoreSubscriptionsFinanceDetailsScreen>(() =>
      _i206.StoreSubscriptionsFinanceDetailsScreen(
          gh<_i202.StoreFinancialSubscriptionsDuesDetailsStateManager>()));
  gh.factory<_i207.StoreSubscriptionsFinanceStateManager>(() =>
      _i207.StoreSubscriptionsFinanceStateManager(
          gh<_i131.SubscriptionsService>()));
  gh.factory<_i208.StoresDuesStateManager>(
      () => _i208.StoresDuesStateManager(gh<_i127.StoresService>()));
  gh.factory<_i209.StoresInActiveStateManager>(
      () => _i209.StoresInActiveStateManager(
            gh<_i127.StoresService>(),
            gh<_i38.ImageUploadService>(),
          ));
  gh.factory<_i210.StoresNeedsSupportStateManager>(
      () => _i210.StoresNeedsSupportStateManager(gh<_i127.StoresService>()));
  gh.factory<_i211.StoresScreen>(
      () => _i211.StoresScreen(gh<_i128.StoresStateManager>()));
  gh.factory<_i212.SubscriptionManagementScreen>(() =>
      _i212.SubscriptionManagementScreen(
          gh<_i204.StoreSubscriptionManagementStateManager>()));
  gh.factory<_i213.SubscriptionToCaptainOfferStateManager>(() =>
      _i213.SubscriptionToCaptainOfferStateManager(
          gh<_i131.SubscriptionsService>()));
  gh.factory<_i214.SupplierAdsStateManager>(
      () => _i214.SupplierAdsStateManager(gh<_i135.SupplierService>()));
  gh.factory<_i215.SupplierCategoriesScreen>(() =>
      _i215.SupplierCategoriesScreen(
          gh<_i134.SupplierCategoriesStateManager>()));
  gh.factory<_i216.SupplierNeedsSupportStateManager>(() =>
      _i216.SupplierNeedsSupportStateManager(gh<_i135.SupplierService>()));
  gh.factory<_i217.SupplierProfileStateManager>(
      () => _i217.SupplierProfileStateManager(gh<_i135.SupplierService>()));
  gh.factory<_i218.SuppliersScreen>(
      () => _i218.SuppliersScreen(gh<_i136.SuppliersStateManager>()));
  gh.factory<_i219.UpdateBranchStateManager>(
      () => _i219.UpdateBranchStateManager(gh<_i145.BranchesListService>()));
  gh.factory<_i220.UpdateScreen>(
      () => _i220.UpdateScreen(gh<_i140.UpdatesStateManager>()));
  gh.factory<_i221.AllAmountCaptainsScreen>(() =>
      _i221.AllAmountCaptainsScreen(gh<_i169.DailyBalanceStateManager>()));
  gh.factory<_i222.BranchesListScreen>(
      () => _i222.BranchesListScreen(gh<_i146.BranchesListStateManager>()));
  gh.factory<_i223.CaptainActivityDetailsScreen>(() =>
      _i223.CaptainActivityDetailsScreen(
          gh<_i148.CaptainActivityDetailsStateManager>()));
  gh.factory<_i224.CaptainAssignOrderScreen>(() =>
      _i224.CaptainAssignOrderScreen(
          gh<_i149.CaptainAssignOrderStateManager>()));
  gh.factory<_i225.CaptainFinanceByCountOrderScreen>(() =>
      _i225.CaptainFinanceByCountOrderScreen(
          gh<_i151.CaptainFinanceByOrderCountStateManager>()));
  gh.factory<_i226.CaptainFinanceByHoursScreen>(() =>
      _i226.CaptainFinanceByHoursScreen(
          gh<_i150.CaptainFinanceByHoursStateManager>()));
  gh.factory<_i227.CaptainFinanceByOrderScreen>(() =>
      _i227.CaptainFinanceByOrderScreen(
          gh<_i152.CaptainFinanceByOrderStateManager>()));
  gh.factory<_i228.CaptainFinanceDailyScreen>(() =>
      _i228.CaptainFinanceDailyScreen(
          gh<_i153.CaptainFinanceDailyStateManager>()));
  gh.factory<_i229.CaptainFinancialDuesDetailsScreen>(() =>
      _i229.CaptainFinancialDuesDetailsScreen(
          gh<_i154.CaptainFinancialDuesDetailsStateManager>()));
  gh.factory<_i230.CaptainFinancialDuesScreen>(() =>
      _i230.CaptainFinancialDuesScreen(
          gh<_i155.CaptainFinancialDuesStateManager>()));
  gh.factory<_i231.CaptainProfileScreen>(
      () => _i231.CaptainProfileScreen(gh<_i158.CaptainProfileStateManager>()));
  gh.factory<_i232.CaptainsActivityScreen>(() =>
      _i232.CaptainsActivityScreen(gh<_i159.CaptainsActivityStateManager>()));
  gh.factory<_i233.CaptainsNeedsSupportScreen>(() =>
      _i233.CaptainsNeedsSupportScreen(
          gh<_i160.CaptainsNeedsSupportStateManager>()));
  gh.factory<_i234.CaptainsRatingScreen>(
      () => _i234.CaptainsRatingScreen(gh<_i161.CaptainsRatingStateManager>()));
  gh.factory<_i235.CarsModule>(() => _i235.CarsModule(gh<_i164.CarsScreen>()));
  gh.factory<_i236.CategoriesModule>(() => _i236.CategoriesModule(
        gh<_i165.CategoriesScreen>(),
        gh<_i196.PackagesScreen>(),
      ));
  gh.factory<_i237.ChatModule>(() => _i237.ChatModule(gh<_i166.ChatPage>()));
  gh.factory<_i238.CompanyFinanceScreen>(
      () => _i238.CompanyFinanceScreen(gh<_i167.CompanyFinanceStateManager>()));
  gh.factory<_i239.CompanyProfileScreen>(
      () => _i239.CompanyProfileScreen(gh<_i168.CompanyProfileStateManager>()));
  gh.factory<_i240.CreateSubscriptionScreen>(() =>
      _i240.CreateSubscriptionScreen(gh<_i178.InitSubscriptionStateManager>()));
  gh.factory<_i241.CreateSubscriptionToCaptainOfferScreen>(() =>
      _i241.CreateSubscriptionToCaptainOfferScreen(
          gh<_i213.SubscriptionToCaptainOfferStateManager>()));
  gh.factory<_i242.DevModule>(
      () => _i242.DevModule(gh<_i182.NewTestOrderScreen>()));
  gh.factory<_i243.EditSubscriptionScreen>(() =>
      _i243.EditSubscriptionScreen(gh<_i171.EditSubscriptionStateManager>()));
  gh.factory<_i244.ExternalDeliveryCompaniesModule>(() =>
      _i244.ExternalDeliveryCompaniesModule(
          gh<_i172.ExternalDeliveryCompaniesScreen>()));
  gh.factory<_i245.InActiveSupplierScreen>(() =>
      _i245.InActiveSupplierScreen(gh<_i176.InActiveSupplierStateManager>()));
  gh.factory<_i246.InitBranchesScreen>(
      () => _i246.InitBranchesScreen(gh<_i177.InitBranchesStateManager>()));
  gh.factory<_i247.MainScreen>(
      () => _i247.MainScreen(gh<_i199.StatisticsScreen>()));
  gh.factory<_i248.MyNotificationsModule>(() => _i248.MyNotificationsModule(
        gh<_i179.MyNotificationsScreen>(),
        gh<_i220.UpdateScreen>(),
      ));
  gh.factory<_i249.NoticeModule>(
      () => _i249.NoticeModule(gh<_i183.NoticeScreen>()));
  gh.factory<_i250.OrderCaptainNotArrivedScreen>(() =>
      _i250.OrderCaptainNotArrivedScreen(
          gh<_i186.OrderCaptainNotArrivedStateManager>()));
  gh.factory<_i251.OrderDetailsScreen>(
      () => _i251.OrderDetailsScreen(gh<_i191.OrderStatusStateManager>()));
  gh.factory<_i252.OrderLogsScreen>(
      () => _i252.OrderLogsScreen(gh<_i189.OrderLogsStateManager>()));
  gh.factory<_i253.OrderTimeLineScreen>(
      () => _i253.OrderTimeLineScreen(gh<_i192.OrderTimeLineStateManager>()));
  gh.factory<_i254.OrdersModule>(() => _i254.OrdersModule(
        gh<_i188.OrderLogsScreen>(),
        gh<_i107.OrdersCashCaptainScreen>(),
        gh<_i193.OrdersCashStoreScreen>(),
        gh<_i139.UpdateOrderScreen>(),
        gh<_i190.OrderPendingScreen>(),
        gh<_i181.NewOrderScreen>(),
        gh<_i185.OrderCaptainLogsScreen>(),
        gh<_i184.OrderActionLogsScreen>(),
        gh<_i110.OrdersWithoutDistanceScreen>(),
        gh<_i194.OrdersReceiveCashScreen>(),
        gh<_i129.SubOrdersScreen>(),
        gh<_i180.NewOrderLinkScreen>(),
        gh<_i119.SearchForOrderScreen>(),
        gh<_i117.RecycleOrderScreen>(),
        gh<_i187.OrderDistanceConflictScreen>(),
      ));
  gh.factory<_i255.PaymentsModule>(() => _i255.PaymentsModule(
        gh<_i225.CaptainFinanceByCountOrderScreen>(),
        gh<_i226.CaptainFinanceByHoursScreen>(),
        gh<_i227.CaptainFinanceByOrderScreen>(),
        gh<_i197.PaymentsToCaptainScreen>(),
        gh<_i200.StoreBalanceScreen>(),
        gh<_i170.DailyPaymentsScreen>(),
        gh<_i221.AllAmountCaptainsScreen>(),
      ));
  gh.factory<_i256.StatisticsModule>(
      () => _i256.StatisticsModule(gh<_i199.StatisticsScreen>()));
  gh.factory<_i257.StoreDuesScreen>(
      () => _i257.StoreDuesScreen(gh<_i201.StoreDuesStateManager>()));
  gh.factory<_i258.StoreInfoScreen>(
      () => _i258.StoreInfoScreen(gh<_i203.StoreProfileStateManager>()));
  gh.factory<_i259.StoreSubscriptionsExpiredFinanceScreen>(() =>
      _i259.StoreSubscriptionsExpiredFinanceScreen(
          gh<_i205.StoreSubscriptionsExpiredFinanceStateManager>()));
  gh.factory<_i260.StoreSubscriptionsFinanceScreen>(() =>
      _i260.StoreSubscriptionsFinanceScreen(
          gh<_i207.StoreSubscriptionsFinanceStateManager>()));
  gh.factory<_i261.StoresDuesScreen>(
      () => _i261.StoresDuesScreen(gh<_i208.StoresDuesStateManager>()));
  gh.factory<_i262.StoresInActiveScreen>(
      () => _i262.StoresInActiveScreen(gh<_i209.StoresInActiveStateManager>()));
  gh.factory<_i263.StoresNeedsSupportScreen>(() =>
      _i263.StoresNeedsSupportScreen(
          gh<_i210.StoresNeedsSupportStateManager>()));
  gh.factory<_i264.SubscriptionsModule>(() => _i264.SubscriptionsModule(
        gh<_i206.StoreSubscriptionsFinanceDetailsScreen>(),
        gh<_i260.StoreSubscriptionsFinanceScreen>(),
        gh<_i212.SubscriptionManagementScreen>(),
        gh<_i259.StoreSubscriptionsExpiredFinanceScreen>(),
        gh<_i240.CreateSubscriptionScreen>(),
        gh<_i241.CreateSubscriptionToCaptainOfferScreen>(),
        gh<_i243.EditSubscriptionScreen>(),
      ));
  gh.factory<_i265.SupplierAdsScreen>(
      () => _i265.SupplierAdsScreen(gh<_i214.SupplierAdsStateManager>()));
  gh.factory<_i266.SupplierCategoriesModule>(() =>
      _i266.SupplierCategoriesModule(gh<_i215.SupplierCategoriesScreen>()));
  gh.factory<_i267.SupplierNeedsSupportScreen>(() =>
      _i267.SupplierNeedsSupportScreen(
          gh<_i216.SupplierNeedsSupportStateManager>()));
  gh.factory<_i268.SupplierProfileScreen>(() =>
      _i268.SupplierProfileScreen(gh<_i217.SupplierProfileStateManager>()));
  gh.factory<_i269.UpdateBranchScreen>(
      () => _i269.UpdateBranchScreen(gh<_i219.UpdateBranchStateManager>()));
  gh.factory<_i270.BranchesModule>(() => _i270.BranchesModule(
        gh<_i222.BranchesListScreen>(),
  ...
  gh.factory<_i271.CaptainsModule>(() => _i271.CaptainsModule(
        ...
        gh<_i175.InActiveCaptainsScreen>(),
        gh<_i162.CaptainsScreen>(),
        gh<_i231.CaptainProfileScreen>(),
        gh<_i233.CaptainsNeedsSupportScreen>(),
        gh<_i147.CaptainAccountBalanceScreen>(),
        gh<_i229.CaptainFinancialDuesDetailsScreen>(),
        gh<_i230.CaptainFinancialDuesScreen>(),
        gh<_i198.PlanScreen>(),
        gh<_i224.CaptainAssignOrderScreen>(),
        gh<_i234.CaptainsRatingScreen>(),
        gh<_i163.CaptinRatingDetailsScreen>(),
        gh<_i232.CaptainsActivityScreen>(),
        gh<_i223.CaptainActivityDetailsScreen>(),
        gh<_i228.CaptainFinanceDailyScreen>(),
      ));
  gh.factory<_i272.CompanyModule>(() => _i272.CompanyModule(
        gh<_i239.CompanyProfileScreen>(),
        gh<_i238.CompanyFinanceScreen>(),
      ));
  ...
  gh.factory<_i274.StoresModule>(() => _i274.StoresModule(
        ...
        gh<_i195.OrdersTopActiveStoreScreen>(),
