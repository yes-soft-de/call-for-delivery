...
import '../module_auth/authoriazation_module.dart' as _i154;
...
import '../module_auth/ui/screen/register_screen/register_screen.dart' as _i134;
...
import '../module_bid_order/ui/screen/order_details_screen.dart' as _i155;
...
import '../module_branches/service/branches_list_service.dart' as _i156;
...
import '../module_categories/state_manager/packages_state_manager.dart'
    as _i129;
import '../module_chat/chat_module.dart' as _i209;
import '../module_chat/manager/chat/chat_manager.dart' as _i91;
import '../module_chat/presistance/chat_hive_helper.dart' as _i18;
...
import '../module_chat/ui/screens/chat_page/chat_page.dart' as _i173;
import '../module_chat_v2/chat_module.dart' as _i208;
import '../module_chat_v2/manager/chat/chat_manager.dart' as _i88;
import '../module_chat_v2/presistance/chat_hive_helper.dart' as _i17;
...
import '../module_chat_v2/ui/screens/chat_page/chat_page.dart' as _i172;
...
import '../module_dev/dev_module.dart' as _i210;
...
import '../module_main/sceen/home_screen.dart' as _i181;
...
import '../module_notice/manager/notice_manager.dart' as _i117;
import '../module_notice/notice_module.dart' as _i29;
import '../module_notice/repository/notice_repository.dart' as _i59;
import '../module_notice/service/notice_service.dart' as _i118;
import '../module_notice/state_manager/notice_state_manager.dart' as _i119;
...
import '../module_orders/state_manager/sub_orders_list_state_manager.dart'
    as _i72;
import '../module_payments/manager/payments_manager.dart' as _i130;
import '../module_payments/payments_module.dart' as _i34;
import '../module_payments/repository/payments_repository.dart' as _i64;
import '../module_payments/service/payments_service.dart' as _i131;
...
import '../module_statistics/manager/statistic_manager.dart' as _i137;
import '../module_statistics/repository/statistics_repository.dart' as _i70;
import '../module_statistics/service/statistics_service.dart' as _i138;
...
import '../module_stores/manager/stores_manager.dart' as _i141;
import '../module_stores/repository/stores_repository.dart' as _i71;
import '../module_stores/service/store_service.dart' as _i142;
...
import '../module_stores/state_manager/order/order_time_line_state_manager.dart'
    as _i190;
import '../module_stores/state_manager/store_dues_state_manager.dart' as _i192;
import '../module_stores/state_manager/store_profile_state_manager.dart'
    as _i194;
import '../module_stores/state_manager/stores_dues_state_manager.dart' as _i198;
...
import '../module_stores/state_manager/stores_need_support_state_manager.dart'
    as _i200;
import '../module_stores/state_manager/stores_state_manager.dart' as _i143;
import '../module_stores/state_manager/top_active_store.dart' as _i151;
import '../module_stores/stores_module.dart' as _i37;
import '../module_subscriptions/manager/subscriptions_manager.dart' as _i144;
import '../module_subscriptions/repository/subscriptions_repository.dart'
    as _i73;
import '../module_subscriptions/service/subscriptions_service.dart' as _i145;
...
import '../module_supplier/service/supplier_service.dart' as _i149;
...
import '../module_supplier/state_manager/supplier_ads_state_manager.dart'
    as _i202;
import '../module_supplier/state_manager/supplier_list.dart' as _i150;
...
import '../module_supplier/ui/screen/supplier_list_screen.dart' as _i206;
...
import '../module_supplier_categories/manager/categories_manager.dart' as _i146;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i113.NaherEvanCaptainsStateManger>(() =>
      _i113.NaherEvanCaptainsStateManger(
          gh<_i99.ExternalDeliveryCompaniesService>()));
  gh.factory<_i114.NewOrderLinkStateManager>(
      () => _i114.NewOrderLinkStateManager(gh<_i63.OrdersService>()));
  gh.factory<_i115.NewOrderStateManager>(
      () => _i115.NewOrderStateManager(gh<_i63.OrdersService>()));
  gh.factory<_i116.NewTestOrderStateManager>(
      () => _i116.NewTestOrderStateManager(gh<_i97.DevService>()));
  gh.factory<_i117.NoticeManager>(
      () => _i117.NoticeManager(gh<_i59.NoticeRepository>()));
  gh.factory<_i118.NoticeService>(
      () => _i118.NoticeService(gh<_i117.NoticeManager>()));
  gh.factory<_i119.NoticeStateManager>(
      () => _i119.NoticeStateManager(gh<_i118.NoticeService>()));
  gh.factory<_i120.OrderActionLogsStateManager>(
      () => _i120.OrderActionLogsStateManager(gh<_i63.OrdersService>()));
  gh.factory<_i121.OrderCaptainLogsStateManager>(
      () => _i121.OrderCaptainLogsStateManager(gh<_i63.OrdersService>()));
  gh.factory<_i122.OrderCashCaptainStateManager>(
      () => _i122.OrderCashCaptainStateManager(gh<_i63.OrdersService>()));
  gh.factory<_i123.OrderDistanceConflictStateManager>(
      () => _i123.OrderDistanceConflictStateManager(gh<_i63.OrdersService>()));
  gh.factory<_i124.OrderPendingStateManager>(
      () => _i124.OrderPendingStateManager(gh<_i63.OrdersService>()));
  gh.factory<_i125.OrderWithoutDistanceStateManager>(
      () => _i125.OrderWithoutDistanceStateManager(gh<_i63.OrdersService>()));
  gh.factory<_i126.OrdersCashStoreStateManager>(
      () => _i126.OrdersCashStoreStateManager(gh<_i63.OrdersService>()));
  gh.factory<_i127.OrdersReceiveCashStateManager>(
      () => _i127.OrdersReceiveCashStateManager(gh<_i63.OrdersService>()));
  gh.factory<_i128.PackageCategoriesStateManager>(
      () => _i128.PackageCategoriesStateManager(gh<_i87.CategoriesService>()));
  gh.factory<_i129.PackagesStateManager>(
      () => _i129.PackagesStateManager(gh<_i87.CategoriesService>()));
  gh.factory<_i130.PaymentsManager>(
      () => _i130.PaymentsManager(gh<_i64.PaymentsRepository>()));
  gh.factory<_i131.PaymentsService>(
      () => _i131.PaymentsService(gh<_i130.PaymentsManager>()));
  gh.factory<_i132.PaymentsToCaptainStateManager>(
      () => _i132.PaymentsToCaptainStateManager(gh<_i131.PaymentsService>()));
  gh.factory<_i133.PlanScreenStateManager>(
      () => _i133.PlanScreenStateManager(gh<_i131.PaymentsService>()));
  gh.factory<_i134.RegisterScreen>(
      () => _i134.RegisterScreen(gh<_i66.RegisterStateManager>()));
  ...
  gh.factory<_i136.SplashModule>(
      () => _i136.SplashModule(gh<_i69.SplashScreen>()));
  gh.factory<_i137.StatisticManager>(
      () => _i137.StatisticManager(gh<_i70.StatisticsRepository>()));
  gh.factory<_i138.StatisticsService>(
      () => _i138.StatisticsService(gh<_i137.StatisticManager>()));
  gh.factory<_i139.StatisticsStateManager>(
      () => _i139.StatisticsStateManager(gh<_i138.StatisticsService>()));
  gh.factory<_i140.StoreBalanceStateManager>(
      () => _i140.StoreBalanceStateManager(gh<_i131.PaymentsService>()));
  gh.factory<_i141.StoreManager>(
      () => _i141.StoreManager(gh<_i71.StoresRepository>()));
  gh.factory<_i142.StoresService>(
      () => _i142.StoresService(gh<_i141.StoreManager>()));
  gh.factory<_i143.StoresStateManager>(() => _i143.StoresStateManager(
        gh<_i142.StoresService>(),
        gh<_i107.ImageUploadService>(),
      ));
  gh.factory<_i144.SubscriptionsManager>(
      () => _i144.SubscriptionsManager(gh<_i73.SubscriptionsRepository>()));
  gh.factory<_i145.SubscriptionsService>(
      () => _i145.SubscriptionsService(gh<_i144.SubscriptionsManager>()));
  gh.factory<_i146.SupplierCategoriesManager>(() =>
      _i146.SupplierCategoriesManager(gh<_i74.SupplierCategoriesRepository>()));
  gh.factory<_i147.SupplierCategoriesService>(() =>
      _i147.SupplierCategoriesService(gh<_i146.SupplierCategoriesManager>()));
  gh.factory<_i148.SupplierCategoriesStateManager>(
      () => _i148.SupplierCategoriesStateManager(
            gh<_i147.SupplierCategoriesService>(),
            gh<_i107.ImageUploadService>(),
          ));
  gh.factory<_i149.SupplierService>(
      () => _i149.SupplierService(gh<_i76.SuppliersManager>()));
  gh.factory<_i150.SuppliersStateManager>(
      () => _i150.SuppliersStateManager(gh<_i149.SupplierService>()));
  gh.factory<_i151.TopActiveStateManagement>(
      () => _i151.TopActiveStateManagement(gh<_i142.StoresService>()));
  gh.factory<_i152.UpdatesStateManager>(() => _i152.UpdatesStateManager(
        gh<_i111.MyNotificationsService>(),
        gh<_i43.AuthService>(),
      ));
  gh.factory<_i153.AssignOrderToExternalCompanyStateManager>(() =>
      _i153.AssignOrderToExternalCompanyStateManager(
          gh<_i99.ExternalDeliveryCompaniesService>()));
  gh.factory<_i154.AuthorizationModule>(() => _i154.AuthorizationModule(
        gh<_i109.LoginScreen>(),
        gh<_i134.RegisterScreen>(),
        gh<_i103.ForgotPassScreen>(),
      ));
  gh.factory<_i155.BidOrderDetailsScreen>(
      () => _i155.BidOrderDetailsScreen(gh<_i81.BidOrderStateManager>()));
  gh.factory<_i156.BranchesListService>(
      () => _i156.BranchesListService(gh<_i82.BranchesManager>()));
  gh.factory<_i157.BranchesListStateManager>(
      () => _i157.BranchesListStateManager(gh<_i156.BranchesListService>()));
  gh.factory<_i158.CaptainActivityDetailsStateManager>(() =>
      _i158.CaptainActivityDetailsStateManager(gh<_i84.CaptainsService>()));
  gh.factory<_i159.CaptainAssignOrderStateManager>(
      () => _i159.CaptainAssignOrderStateManager(gh<_i84.CaptainsService>()));
  gh.factory<_i160.CaptainDuesStateManager>(
      () => _i160.CaptainDuesStateManager(gh<_i84.CaptainsService>()));
  gh.factory<_i161.CaptainFinanceByHoursStateManager>(() =>
      _i161.CaptainFinanceByHoursStateManager(gh<_i131.PaymentsService>()));
  gh.factory<_i162.CaptainFinanceByOrderCountStateManager>(() =>
      _i162.CaptainFinanceByOrderCountStateManager(
          gh<_i131.PaymentsService>()));
  gh.factory<_i163.CaptainFinanceByOrderStateManager>(() =>
      _i163.CaptainFinanceByOrderStateManager(gh<_i131.PaymentsService>()));
  gh.factory<_i164.CaptainOfferStateManager>(
      () => _i164.CaptainOfferStateManager(gh<_i84.CaptainsService>()));
  gh.factory<_i165.CaptainPaymentStateManager>(
      () => _i165.CaptainPaymentStateManager(gh<_i131.PaymentsService>()));
  gh.factory<_i166.CaptainPreviousPaymentsStateManager>(() =>
      _i166.CaptainPreviousPaymentsStateManager(gh<_i131.PaymentsService>()));
  gh.factory<_i167.CaptainProfileStateManager>(
      () => _i167.CaptainProfileStateManager(gh<_i84.CaptainsService>()));
  gh.factory<_i168.CaptainRatingDetailsStateManager>(
      () => _i168.CaptainRatingDetailsStateManager(gh<_i84.CaptainsService>()));
  gh.factory<_i169.CaptainsActivityStateManager>(
      () => _i169.CaptainsActivityStateManager(gh<_i84.CaptainsService>()));
  gh.factory<_i170.CaptainsNeedsSupportStateManager>(
      () => _i170.CaptainsNeedsSupportStateManager(gh<_i84.CaptainsService>()));
  gh.factory<_i171.CaptainsRatingStateManager>(
      () => _i171.CaptainsRatingStateManager(gh<_i84.CaptainsService>()));
  gh.factory<_i172.Chat2Page>(() => _i172.Chat2Page(
        gh<_i90.Chat2StateManager>(),
        gh<_i107.ImageUploadService>(),
        gh<_i43.AuthService>(),
        gh<_i17.ChatHiveHelper>(),
      ));
  gh.factory<_i173.ChatPage>(() => _i173.ChatPage(
        gh<_i93.ChatStateManager>(),
        gh<_i107.ImageUploadService>(),
        gh<_i43.AuthService>(),
        gh<_i18.ChatHiveHelper>(),
      ));
  gh.factory<_i174.CompanyFinanceStateManager>(
      () => _i174.CompanyFinanceStateManager(gh<_i95.CompanyService>()));
  gh.factory<_i175.CompanyProfileStateManager>(
      () => _i175.CompanyProfileStateManager(gh<_i95.CompanyService>()));
  gh.factory<_i176.DeliveryCompanyAllSettingsStateManager>(() =>
      _i176.DeliveryCompanyAllSettingsStateManager(
          gh<_i99.ExternalDeliveryCompaniesService>()));
  gh.factory<_i177.EditDeliveryCompanySettingScreenStateManager>(() =>
      _i177.EditDeliveryCompanySettingScreenStateManager(
          gh<_i99.ExternalDeliveryCompaniesService>()));
  gh.factory<_i178.EditStoreSettingStateManager>(
      () => _i178.EditStoreSettingStateManager(
            gh<_i142.StoresService>(),
            gh<_i107.ImageUploadService>(),
          ));
  gh.factory<_i179.EditSubscriptionStateManager>(() =>
      _i179.EditSubscriptionStateManager(gh<_i145.SubscriptionsService>()));
  gh.factory<_i180.FilterOrderTopStateManager>(
      () => _i180.FilterOrderTopStateManager(gh<_i142.StoresService>()));
  gh.factory<_i181.HomeScreen>(
      () => _i181.HomeScreen(gh<_i106.HomeStateManager>()));
  gh.factory<_i182.InActiveSupplierStateManager>(
      () => _i182.InActiveSupplierStateManager(gh<_i149.SupplierService>()));
  gh.factory<_i183.InitBranchesStateManager>(
      () => _i183.InitBranchesStateManager(gh<_i156.BranchesListService>()));
  gh.factory<_i184.InitSubscriptionStateManager>(() =>
      _i184.InitSubscriptionStateManager(gh<_i145.SubscriptionsService>()));
  gh.factory<_i185.MainModule>(() => _i185.MainModule(
        gh<_i27.MainScreen>(),
        gh<_i181.HomeScreen>(),
      ));
  gh.factory<_i186.NewTestOrderScreen>(
      () => _i186.NewTestOrderScreen(gh<_i116.NewTestOrderStateManager>()));
  gh.factory<_i187.OrderCaptainNotArrivedStateManager>(() =>
      _i187.OrderCaptainNotArrivedStateManager(gh<_i142.StoresService>()));
  gh.factory<_i188.OrderLogsStateManager>(
      () => _i188.OrderLogsStateManager(gh<_i142.StoresService>()));
  gh.factory<_i189.OrderStatusStateManager>(
      () => _i189.OrderStatusStateManager(gh<_i142.StoresService>()));
  gh.factory<_i190.OrderTimeLineStateManager>(
      () => _i190.OrderTimeLineStateManager(gh<_i142.StoresService>()));
  gh.factory<_i191.ReceiptsStateManager>(
      () => _i191.ReceiptsStateManager(gh<_i145.SubscriptionsService>()));
  gh.factory<_i192.StoreDuesStateManager>(() => _i192.StoreDuesStateManager(
        gh<_i142.StoresService>(),
        gh<_i131.PaymentsService>(),
      ));
  gh.factory<_i193.StoreFinancialSubscriptionsDuesDetailsStateManager>(
      () => _i193.StoreFinancialSubscriptionsDuesDetailsStateManager(
            gh<_i131.PaymentsService>(),
            gh<_i145.SubscriptionsService>(),
          ));
  gh.factory<_i194.StoreProfileStateManager>(
      () => _i194.StoreProfileStateManager(
            gh<_i142.StoresService>(),
            gh<_i107.ImageUploadService>(),
          ));
  gh.factory<_i195.StoreSubscriptionManagementStateManager>(() =>
      _i195.StoreSubscriptionManagementStateManager(
          gh<_i145.SubscriptionsService>()));
  gh.factory<_i196.StoreSubscriptionsExpiredFinanceStateManager>(() =>
      _i196.StoreSubscriptionsExpiredFinanceStateManager(
          gh<_i145.SubscriptionsService>()));
  gh.factory<_i197.StoreSubscriptionsFinanceStateManager>(() =>
      _i197.StoreSubscriptionsFinanceStateManager(
          gh<_i145.SubscriptionsService>()));
  gh.factory<_i198.StoresDuesStateManager>(
      () => _i198.StoresDuesStateManager(gh<_i142.StoresService>()));
  gh.factory<_i199.StoresInActiveStateManager>(
      () => _i199.StoresInActiveStateManager(
            gh<_i142.StoresService>(),
            gh<_i107.ImageUploadService>(),
          ));
  gh.factory<_i200.StoresNeedsSupportStateManager>(
      () => _i200.StoresNeedsSupportStateManager(gh<_i142.StoresService>()));
  ...
  gh.factory<_i202.SupplierAdsStateManager>(
      () => _i202.SupplierAdsStateManager(gh<_i149.SupplierService>()));
  gh.factory<_i203.SupplierCategoriesScreen>(() =>
      _i203.SupplierCategoriesScreen(
          gh<_i148.SupplierCategoriesStateManager>()));
  gh.factory<_i204.SupplierNeedsSupportStateManager>(() =>
      _i204.SupplierNeedsSupportStateManager(gh<_i149.SupplierService>()));
  gh.factory<_i205.SupplierProfileStateManager>(
      () => _i205.SupplierProfileStateManager(gh<_i149.SupplierService>()));
  gh.factory<_i206.SuppliersScreen>(
      () => _i206.SuppliersScreen(gh<_i150.SuppliersStateManager>()));
  gh.factory<_i207.UpdateBranchStateManager>(
      () => _i207.UpdateBranchStateManager(gh<_i156.BranchesListService>()));
  gh.factory<_i208.Chat2Module>(() => _i208.Chat2Module(
        gh<_i172.Chat2Page>(),
        gh<_i43.AuthService>(),
      ));
  gh.factory<_i209.ChatModule>(() => _i209.ChatModule(
        gh<_i173.ChatPage>(),
        gh<_i172.Chat2Page>(),
      ));
  gh.factory<_i210.DevModule>(
      () => _i210.DevModule(gh<_i186.NewTestOrderScreen>()));
  gh.factory<_i211.InActiveSupplierScreen>(() =>
      _i211.InActiveSupplierScreen(gh<_i182.InActiveSupplierStateManager>()));
  gh.factory<_i212.SupplierAdsScreen>(
      () => _i212.SupplierAdsScreen(gh<_i202.SupplierAdsStateManager>()));
  gh.factory<_i213.SupplierCategoriesModule>(() =>
      _i213.SupplierCategoriesModule(gh<_i203.SupplierCategoriesScreen>()));
  ...
  gh.factory<_i215.SupplierProfileScreen>(() =>
      _i215.SupplierProfileScreen(gh<_i205.SupplierProfileStateManager>()));
  ...
  gh.factory<_i217.MyApp>(() => _i217.MyApp(
        ...
        gh<_i136.SplashModule>(),
        gh<_i154.AuthorizationModule>(),
        gh<_i209.ChatModule>(),
        gh<_i135.SettingsModule>(),
        gh<_i185.MainModule>(),
