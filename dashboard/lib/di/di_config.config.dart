...
import '../module_branches/ui/screens/update_branches_screen/update_branches_screen.dart'
    as _i122;
import '../module_captain/captains_module.dart' as _i124;
...
import '../module_captain/state_manager/in_active_captains_state_manager.dart'
    as _i51;
import '../module_captain/ui/screen/captain_needs_support_screen.dart' as _i106;
import '../module_captain/ui/screen/captain_profile_screen.dart' as _i105;
import '../module_captain/ui/screen/captains_list_screen.dart' as _i78;
import '../module_captain/ui/screen/captains_offer_screen.dart' as _i75;
import '../module_captain/ui/screen/in_active_captains_screen.dart' as _i84;
import '../module_categories/categories_module.dart' as _i107;
...
import '../module_categories/ui/screen/categories_screen.dart' as _i79;
import '../module_categories/ui/screen/packages_screen.dart' as _i92;
import '../module_chat/chat_module.dart' as _i108;
...
import '../module_company/company_module.dart' as _i125;
...
import '../module_company/state_manager/company_profile_state_manager.dart'
    as _i82;
import '../module_company/ui/screen/company_finance_screen.dart' as _i109;
import '../module_company/ui/screen/company_profile_screen.dart' as _i110;
import '../module_localization/presistance/localization_preferences_helper/localization_preferences_helper.dart'
    as _i7;
import '../module_localization/service/localization_service/localization_service.dart'
    as _i8;
import '../module_main/main_module.dart' as _i112;
import '../module_main/manager/home_manager.dart' as _i48;
import '../module_main/repository/home_repository.dart' as _i26;
import '../module_main/sceen/home_screen.dart' as _i83;
import '../module_main/sceen/main_screen.dart' as _i86;
...
import '../module_notice/notice_module.dart' as _i113;
...
import '../module_notice/ui/screen/notice_screen.dart' as _i87;
...
import '../module_payments/payments_module.dart' as _i118;
...
import '../module_payments/ui/screen/captain_finance_by_order_screen.dart'
    as _i104;
import '../module_payments/ui/screen/payment_to_captain_screen.dart' as _i93;
import '../module_payments/ui/screen/store_balance_screen.dart' as _i95;
...
import '../module_stores/stores_module.dart' as _i126;
import '../module_stores/ui/screen/order/order_captain_not_arrived.dart'
    as _i114;
import '../module_stores/ui/screen/order/order_details_screen.dart' as _i115;
import '../module_stores/ui/screen/order/order_logs_screen.dart' as _i116;
import '../module_stores/ui/screen/order/order_time_line_screen.dart' as _i117;
import '../module_stores/ui/screen/store_info_screen.dart' as _i119;
import '../module_stores/ui/screen/stores_inactive_screen.dart' as _i120;
import '../module_stores/ui/screen/stores_needs_support_screen.dart' as _i121;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i60.PaymentsToCaptainStateManager>(
      () => _i60.PaymentsToCaptainStateManager(get<_i59.PaymentsService>()));
  gh.factory<_i61.RegisterScreen>(
      () => _i61.RegisterScreen(get<_i32.RegisterStateManager>()));
  ...
  gh.factory<_i63.SplashModule>(
      () => _i63.SplashModule(get<_i33.SplashScreen>()));
  gh.factory<_i64.StoreBalanceStateManager>(
      () => _i64.StoreBalanceStateManager(get<_i59.PaymentsService>()));
  gh.factory<_i65.StoreManager>(
      () => _i65.StoreManager(get<_i34.StoresRepository>()));
  gh.factory<_i66.StoresService>(
      () => _i66.StoresService(get<_i65.StoreManager>()));
  ...
  gh.factory<_i71.CaptainFinanceByHoursStateManager>(() =>
      _i71.CaptainFinanceByHoursStateManager(get<_i59.PaymentsService>()));
  gh.factory<_i72.CaptainFinanceByOrderCountStateManager>(() =>
      _i72.CaptainFinanceByOrderCountStateManager(get<_i59.PaymentsService>()));
  gh.factory<_i73.CaptainFinanceByOrderStateManager>(() =>
      _i73.CaptainFinanceByOrderStateManager(get<_i59.PaymentsService>()));
  gh.factory<_i74.CaptainOfferStateManager>(() => _i74.CaptainOfferStateManager(
      get<_i37.CaptainsService>(), get<_i27.ImageUploadService>()));
  gh.factory<_i75.CaptainOffersScreen>(
      () => _i75.CaptainOffersScreen(get<_i74.CaptainOfferStateManager>()));
  gh.factory<_i76.CaptainProfileStateManager>(
      () => _i76.CaptainProfileStateManager(get<_i37.CaptainsService>()));
  gh.factory<_i77.CaptainsNeedsSupportStateManager>(
      () => _i77.CaptainsNeedsSupportStateManager(get<_i37.CaptainsService>()));
  gh.factory<_i78.CaptainsScreen>(
      () => _i78.CaptainsScreen(get<_i38.CaptainsStateManager>()));
  gh.factory<_i79.CategoriesScreen>(
      () => _i79.CategoriesScreen(get<_i56.PackageCategoriesStateManager>()));
  gh.factory<_i80.ChatPage>(() => _i80.ChatPage(
      get<_i43.ChatStateManager>(),
      get<_i27.ImageUploadService>(),
      get<_i19.AuthService>(),
      get<_i4.ChatHiveHelper>()));
  gh.factory<_i81.CompanyFinanceStateManager>(() =>
      _i81.CompanyFinanceStateManager(
          get<_i19.AuthService>(), get<_i45.CompanyService>()));
  gh.factory<_i82.CompanyProfileStateManager>(() =>
      _i82.CompanyProfileStateManager(
          get<_i19.AuthService>(), get<_i45.CompanyService>()));
  gh.factory<_i83.HomeScreen>(
      () => _i83.HomeScreen(get<_i50.HomeStateManager>()));
  gh.factory<_i84.InActiveCaptainsScreen>(() =>
      _i84.InActiveCaptainsScreen(get<_i51.InActiveCaptainsStateManager>()));
  gh.factory<_i85.InitBranchesStateManager>(
      () => _i85.InitBranchesStateManager(get<_i69.BranchesListService>()));
  gh.factory<_i86.MainScreen>(() => _i86.MainScreen(get<_i83.HomeScreen>()));
  gh.factory<_i87.NoticeScreen>(
      () => _i87.NoticeScreen(get<_i55.NoticeStateManager>()));
  gh.factory<_i88.OrderCaptainNotArrivedStateManager>(
      () => _i88.OrderCaptainNotArrivedStateManager(get<_i66.StoresService>()));
  gh.factory<_i89.OrderLogsStateManager>(
      () => _i89.OrderLogsStateManager(get<_i66.StoresService>()));
  gh.factory<_i90.OrderStatusStateManager>(() => _i90.OrderStatusStateManager(
      get<_i66.StoresService>(), get<_i19.AuthService>()));
  gh.factory<_i91.OrderTimeLineStateManager>(() =>
      _i91.OrderTimeLineStateManager(
          get<_i66.StoresService>(), get<_i19.AuthService>()));
  gh.factory<_i92.PackagesScreen>(
      () => _i92.PackagesScreen(get<_i57.PackagesStateManager>()));
  gh.factory<_i93.PaymentsToCaptainScreen>(() =>
      _i93.PaymentsToCaptainScreen(get<_i60.PaymentsToCaptainStateManager>()));
  gh.factory<_i94.SettingsModule>(() => _i94.SettingsModule(
      get<_i62.SettingsScreen>(), get<_i16.ChooseLocalScreen>()));
  gh.factory<_i95.StoreBalanceScreen>(
      () => _i95.StoreBalanceScreen(get<_i64.StoreBalanceStateManager>()));
  gh.factory<_i96.StoreProfileStateManager>(
      () => _i96.StoreProfileStateManager(get<_i66.StoresService>()));
  gh.factory<_i97.StoresInActiveStateManager>(() =>
      _i97.StoresInActiveStateManager(get<_i66.StoresService>(),
          get<_i19.AuthService>(), get<_i27.ImageUploadService>()));
  gh.factory<_i98.StoresNeedsSupportStateManager>(
      () => _i98.StoresNeedsSupportStateManager(get<_i66.StoresService>()));
  gh.factory<_i99.StoresScreen>(
      () => _i99.StoresScreen(get<_i67.StoresStateManager>()));
  gh.factory<_i100.UpdateBranchStateManager>(
      () => _i100.UpdateBranchStateManager(get<_i69.BranchesListService>()));
  gh.factory<_i101.BranchesListScreen>(
      () => _i101.BranchesListScreen(get<_i70.BranchesListStateManager>()));
  gh.factory<_i102.CaptainFinanceByCountOrderScreen>(() =>
      _i102.CaptainFinanceByCountOrderScreen(
          get<_i72.CaptainFinanceByOrderCountStateManager>()));
  gh.factory<_i103.CaptainFinanceByHoursScreen>(() =>
      _i103.CaptainFinanceByHoursScreen(
          get<_i71.CaptainFinanceByHoursStateManager>()));
  gh.factory<_i104.CaptainFinanceByOrderScreen>(() =>
      _i104.CaptainFinanceByOrderScreen(
          get<_i73.CaptainFinanceByOrderStateManager>()));
  gh.factory<_i105.CaptainProfileScreen>(
      () => _i105.CaptainProfileScreen(get<_i76.CaptainProfileStateManager>()));
  gh.factory<_i106.CaptainsNeedsSupportScreen>(() =>
      _i106.CaptainsNeedsSupportScreen(
          get<_i77.CaptainsNeedsSupportStateManager>()));
  gh.factory<_i107.CategoriesModule>(() => _i107.CategoriesModule(
      get<_i79.CategoriesScreen>(), get<_i92.PackagesScreen>()));
  gh.factory<_i108.ChatModule>(
      () => _i108.ChatModule(get<_i80.ChatPage>(), get<_i19.AuthService>()));
  gh.factory<_i109.CompanyFinanceScreen>(
      () => _i109.CompanyFinanceScreen(get<_i81.CompanyFinanceStateManager>()));
  gh.factory<_i110.CompanyProfileScreen>(
      () => _i110.CompanyProfileScreen(get<_i82.CompanyProfileStateManager>()));
  gh.factory<_i111.InitBranchesScreen>(
      () => _i111.InitBranchesScreen(get<_i85.InitBranchesStateManager>()));
  gh.factory<_i112.MainModule>(
      () => _i112.MainModule(get<_i86.MainScreen>(), get<_i83.HomeScreen>()));
  gh.factory<_i113.NoticeModule>(
      () => _i113.NoticeModule(get<_i87.NoticeScreen>()));
  gh.factory<_i114.OrderCaptainNotArrivedScreen>(() =>
      _i114.OrderCaptainNotArrivedScreen(
          get<_i88.OrderCaptainNotArrivedStateManager>()));
  gh.factory<_i115.OrderDetailsScreen>(
      () => _i115.OrderDetailsScreen(get<_i90.OrderStatusStateManager>()));
  gh.factory<_i116.OrderLogsScreen>(
      () => _i116.OrderLogsScreen(get<_i89.OrderLogsStateManager>()));
  gh.factory<_i117.OrderTimeLineScreen>(
      () => _i117.OrderTimeLineScreen(get<_i91.OrderTimeLineStateManager>()));
  gh.factory<_i118.PaymentsModule>(() => _i118.PaymentsModule(
      get<_i102.CaptainFinanceByCountOrderScreen>(),
      get<_i103.CaptainFinanceByHoursScreen>(),
      get<_i104.CaptainFinanceByOrderScreen>(),
      get<_i93.PaymentsToCaptainScreen>()));
  gh.factory<_i119.StoreInfoScreen>(
      () => _i119.StoreInfoScreen(get<_i96.StoreProfileStateManager>()));
  gh.factory<_i120.StoresInActiveScreen>(
      () => _i120.StoresInActiveScreen(get<_i97.StoresInActiveStateManager>()));
  gh.factory<_i121.StoresNeedsSupportScreen>(() =>
      _i121.StoresNeedsSupportScreen(
          get<_i98.StoresNeedsSupportStateManager>()));
  gh.factory<_i122.UpdateBranchScreen>(
      () => _i122.UpdateBranchScreen(get<_i100.UpdateBranchStateManager>()));
  gh.factory<_i123.BranchesModule>(() => _i123.BranchesModule(
      get<_i101.BranchesListScreen>(),
      get<_i122.UpdateBranchScreen>(),
      get<_i111.InitBranchesScreen>()));
  gh.factory<_i124.CaptainsModule>(() => _i124.CaptainsModule(
      get<_i75.CaptainOffersScreen>(),
      get<_i84.InActiveCaptainsScreen>(),
      get<_i78.CaptainsScreen>(),
      get<_i105.CaptainProfileScreen>(),
      get<_i106.CaptainsNeedsSupportScreen>()));
  gh.factory<_i125.CompanyModule>(() => _i125.CompanyModule(
      get<_i110.CompanyProfileScreen>(), get<_i109.CompanyFinanceScreen>()));
  gh.factory<_i126.StoresModule>(() => _i126.StoresModule(
      get<_i99.StoresScreen>(),
      get<_i119.StoreInfoScreen>(),
      get<_i120.StoresInActiveScreen>(),
      get<_i95.StoreBalanceScreen>(),
      get<_i121.StoresNeedsSupportScreen>(),
      get<_i115.OrderDetailsScreen>(),
      get<_i116.OrderLogsScreen>(),
      get<_i114.OrderCaptainNotArrivedScreen>(),
      get<_i117.OrderTimeLineScreen>()));
  gh.factory<_i127.MyApp>(() => _i127.MyApp(
      ...
      get<_i108.ChatModule>(),
      get<_i94.SettingsModule>(),
      get<_i112.MainModule>(),
      get<_i126.StoresModule>(),
      get<_i107.CategoriesModule>(),
      get<_i125.CompanyModule>(),
      get<_i123.BranchesModule>(),
      get<_i113.NoticeModule>(),
      get<_i124.CaptainsModule>(),
      get<_i118.PaymentsModule>()));
