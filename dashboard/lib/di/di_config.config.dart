...
import '../module_branches/branches_module.dart' as _i208;
...
import '../module_branches/ui/screens/update_branches_screen/update_branches_screen.dart'
    as _i207;
import '../module_captain/captains_module.dart' as _i209;
...
import '../module_captain/ui/screen/captain_financial_dues_screen.dart'
    as _i178;
import '../module_captain/ui/screen/captain_needs_support_screen.dart' as _i180;
import '../module_captain/ui/screen/captain_profile_screen.dart' as _i179;
import '../module_captain/ui/screen/captains_assign_order_screen.dart' as _i173;
...
import '../module_categories/categories_module.dart' as _i182;
...
import '../module_chat/chat_module.dart' as _i183;
...
import '../module_company/company_module.dart' as _i210;
...
import '../module_company/state_manager/company_profile_state_manager.dart'
    as _i132;
import '../module_company/ui/screen/company_finance_screen.dart' as _i184;
import '../module_company/ui/screen/company_profile_screen.dart' as _i185;
import '../module_deep_links/repository/deep_link_repository.dart' as _i31;
import '../module_delivary_car/cars_module.dart' as _i181;
...
import '../module_localization/service/localization_service/localization_service.dart'
    as _i10;
import '../module_main/main_module.dart' as _i189;
...
import '../module_notice/notice_module.dart' as _i190;
...
import '../module_orders/orders_module.dart' as _i195;
...
import '../module_payments/payments_module.dart' as _i196;
...
import '../module_stores/stores_module.dart' as _i211;
import '../module_stores/ui/screen/order/order_captain_not_arrived.dart'
    as _i191;
import '../module_stores/ui/screen/order/order_details_screen.dart' as _i192;
import '../module_stores/ui/screen/order/order_logs_screen.dart' as _i193;
import '../module_stores/ui/screen/order/order_time_line_screen.dart' as _i194;
import '../module_stores/ui/screen/store_info_screen.dart' as _i197;
import '../module_stores/ui/screen/stores_inactive_screen.dart' as _i200;
import '../module_stores/ui/screen/stores_needs_support_screen.dart' as _i201;
...
import '../module_subscriptions/state_manager/store_subscriptions_finance_state_manager.dart'
    as _i161;
import '../module_subscriptions/subscriptions_module.dart' as _i202;
...
import '../module_supplier/state_manager/supplier_profile_state_manager.dart'
    as _i169;
import '../module_supplier/supplier_module.dart' as _i212;
import '../module_supplier/ui/screen/in_active_supplier_screen.dart' as _i187;
import '../module_supplier/ui/screen/supplier_ads_screen.dart' as _i203;
import '../module_supplier/ui/screen/supplier_list_screen.dart' as _i170;
import '../module_supplier/ui/screen/supplier_needs_support_screen.dart'
    as _i205;
import '../module_supplier/ui/screen/supplier_profile_screen.dart' as _i206;
import '../module_supplier_categories/categories_supplier_module.dart' as _i204;
...
import '../module_upload/service/image_upload/image_upload_service.dart'
    as _i34;
import '../utils/global/global_state_manager.dart' as _i214;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i166.SupplierAdsStateManager>(
      () => _i166.SupplierAdsStateManager(get<_i107.SupplierService>()));
  gh.factory<_i167.SupplierCategoriesScreen>(() =>
      _i167.SupplierCategoriesScreen(
          get<_i106.SupplierCategoriesStateManager>()));
  gh.factory<_i168.SupplierNeedsSupportStateManager>(() =>
      _i168.SupplierNeedsSupportStateManager(get<_i107.SupplierService>()));
  gh.factory<_i169.SupplierProfileStateManager>(
      () => _i169.SupplierProfileStateManager(get<_i107.SupplierService>()));
  gh.factory<_i170.SuppliersScreen>(
      () => _i170.SuppliersScreen(get<_i108.SuppliersStateManager>()));
  gh.factory<_i171.UpdateBranchStateManager>(
      () => _i171.UpdateBranchStateManager(get<_i114.BranchesListService>()));
  gh.factory<_i172.BranchesListScreen>(
      () => _i172.BranchesListScreen(get<_i115.BranchesListStateManager>()));
  gh.factory<_i173.CaptainAssignOrderScreen>(() =>
      _i173.CaptainAssignOrderScreen(
          get<_i117.CaptainAssignOrderStateManager>()));
  gh.factory<_i174.CaptainFinanceByCountOrderScreen>(() =>
      _i174.CaptainFinanceByCountOrderScreen(
          get<_i119.CaptainFinanceByOrderCountStateManager>()));
  gh.factory<_i175.CaptainFinanceByHoursScreen>(() =>
      _i175.CaptainFinanceByHoursScreen(
          get<_i118.CaptainFinanceByHoursStateManager>()));
  gh.factory<_i176.CaptainFinanceByOrderScreen>(() =>
      _i176.CaptainFinanceByOrderScreen(
          get<_i120.CaptainFinanceByOrderStateManager>()));
  gh.factory<_i177.CaptainFinancialDuesDetailsScreen>(() =>
      _i177.CaptainFinancialDuesDetailsScreen(
          get<_i121.CaptainFinancialDuesDetailsStateManager>()));
  gh.factory<_i178.CaptainFinancialDuesScreen>(() =>
      _i178.CaptainFinancialDuesScreen(
          get<_i122.CaptainFinancialDuesStateManager>()));
  gh.factory<_i179.CaptainProfileScreen>(() =>
      _i179.CaptainProfileScreen(get<_i125.CaptainProfileStateManager>()));
  gh.factory<_i180.CaptainsNeedsSupportScreen>(() =>
      _i180.CaptainsNeedsSupportScreen(
          get<_i126.CaptainsNeedsSupportStateManager>()));
  gh.factory<_i181.CarsModule>(() => _i181.CarsModule(get<_i128.CarsScreen>()));
  gh.factory<_i182.CategoriesModule>(() => _i182.CategoriesModule(
      get<_i129.CategoriesScreen>(), get<_i151.PackagesScreen>()));
  gh.factory<_i183.ChatModule>(
      () => _i183.ChatModule(get<_i130.ChatPage>(), get<_i23.AuthService>()));
  gh.factory<_i184.CompanyFinanceScreen>(() =>
      _i184.CompanyFinanceScreen(get<_i131.CompanyFinanceStateManager>()));
  gh.factory<_i185.CompanyProfileScreen>(() =>
      _i185.CompanyProfileScreen(get<_i132.CompanyProfileStateManager>()));
  gh.factory<_i186.CreateSubscriptionScreen>(() =>
      _i186.CreateSubscriptionScreen(
          get<_i137.InitSubscriptionStateManager>()));
  gh.factory<_i187.InActiveSupplierScreen>(() =>
      _i187.InActiveSupplierScreen(get<_i135.InActiveSupplierStateManager>()));
  gh.factory<_i188.InitBranchesScreen>(
      () => _i188.InitBranchesScreen(get<_i136.InitBranchesStateManager>()));
  gh.factory<_i189.MainModule>(
      () => _i189.MainModule(get<_i138.MainScreen>(), get<_i133.HomeScreen>()));
  gh.factory<_i190.NoticeModule>(
      () => _i190.NoticeModule(get<_i140.NoticeScreen>()));
  gh.factory<_i191.OrderCaptainNotArrivedScreen>(() =>
      _i191.OrderCaptainNotArrivedScreen(
          get<_i143.OrderCaptainNotArrivedStateManager>()));
  gh.factory<_i192.OrderDetailsScreen>(
      () => _i192.OrderDetailsScreen(get<_i147.OrderStatusStateManager>()));
  gh.factory<_i193.OrderLogsScreen>(
      () => _i193.OrderLogsScreen(get<_i145.OrderLogsStateManager>()));
  gh.factory<_i194.OrderTimeLineScreen>(
      () => _i194.OrderTimeLineScreen(get<_i148.OrderTimeLineStateManager>()));
  gh.factory<_i195.OrdersModule>(() => _i195.OrdersModule(
  ...
  gh.factory<_i196.PaymentsModule>(() => _i196.PaymentsModule(
      get<_i174.CaptainFinanceByCountOrderScreen>(),
      get<_i175.CaptainFinanceByHoursScreen>(),
      get<_i176.CaptainFinanceByOrderScreen>(),
      get<_i152.PaymentsToCaptainScreen>(),
      get<_i155.StoreBalanceScreen>()));
  gh.factory<_i197.StoreInfoScreen>(
      () => _i197.StoreInfoScreen(get<_i157.StoreProfileStateManager>()));
  gh.factory<_i198.StoreSubscriptionsExpiredFinanceScreen>(() =>
      _i198.StoreSubscriptionsExpiredFinanceScreen(
          get<_i159.StoreSubscriptionsExpiredFinanceStateManager>()));
  gh.factory<_i199.StoreSubscriptionsFinanceScreen>(() =>
      _i199.StoreSubscriptionsFinanceScreen(
          get<_i161.StoreSubscriptionsFinanceStateManager>()));
  gh.factory<_i200.StoresInActiveScreen>(() =>
      _i200.StoresInActiveScreen(get<_i162.StoresInActiveStateManager>()));
  gh.factory<_i201.StoresNeedsSupportScreen>(() =>
      _i201.StoresNeedsSupportScreen(
          get<_i163.StoresNeedsSupportStateManager>()));
  gh.factory<_i202.SubscriptionsModule>(() => _i202.SubscriptionsModule(
      get<_i160.StoreSubscriptionsFinanceDetailsScreen>(),
      get<_i199.StoreSubscriptionsFinanceScreen>(),
      get<_i165.SubscriptionManagementScreen>(),
      get<_i198.StoreSubscriptionsExpiredFinanceScreen>(),
      get<_i186.CreateSubscriptionScreen>()));
  gh.factory<_i203.SupplierAdsScreen>(
      () => _i203.SupplierAdsScreen(get<_i166.SupplierAdsStateManager>()));
  gh.factory<_i204.SupplierCategoriesModule>(() =>
      _i204.SupplierCategoriesModule(get<_i167.SupplierCategoriesScreen>()));
  gh.factory<_i205.SupplierNeedsSupportScreen>(() =>
      _i205.SupplierNeedsSupportScreen(
          get<_i168.SupplierNeedsSupportStateManager>()));
  gh.factory<_i206.SupplierProfileScreen>(() =>
      _i206.SupplierProfileScreen(get<_i169.SupplierProfileStateManager>()));
  gh.factory<_i207.UpdateBranchScreen>(
      () => _i207.UpdateBranchScreen(get<_i171.UpdateBranchStateManager>()));
  gh.factory<_i208.BranchesModule>(() => _i208.BranchesModule(
      get<_i172.BranchesListScreen>(),
      get<_i207.UpdateBranchScreen>(),
      get<_i188.InitBranchesScreen>()));
  gh.factory<_i209.CaptainsModule>(() => _i209.CaptainsModule(
      get<_i124.CaptainOffersScreen>(),
      get<_i134.InActiveCaptainsScreen>(),
      get<_i127.CaptainsScreen>(),
      get<_i179.CaptainProfileScreen>(),
      get<_i180.CaptainsNeedsSupportScreen>(),
      get<_i116.CaptainAccountBalanceScreen>(),
      get<_i177.CaptainFinancialDuesDetailsScreen>(),
      get<_i178.CaptainFinancialDuesScreen>(),
      get<_i153.PlanScreen>(),
      get<_i173.CaptainAssignOrderScreen>()));
  gh.factory<_i210.CompanyModule>(() => _i210.CompanyModule(
      get<_i185.CompanyProfileScreen>(), get<_i184.CompanyFinanceScreen>()));
  gh.factory<_i211.StoresModule>(() => _i211.StoresModule(
      get<_i164.StoresScreen>(),
      get<_i197.StoreInfoScreen>(),
      get<_i200.StoresInActiveScreen>(),
      get<_i155.StoreBalanceScreen>(),
      get<_i201.StoresNeedsSupportScreen>(),
      get<_i192.OrderDetailsScreen>(),
      get<_i193.OrderLogsScreen>(),
      get<_i191.OrderCaptainNotArrivedScreen>(),
      get<_i194.OrderTimeLineScreen>()));
  gh.factory<_i212.SupplierModule>(() => _i212.SupplierModule(
      get<_i187.InActiveSupplierScreen>(),
      get<_i170.SuppliersScreen>(),
      get<_i206.SupplierProfileScreen>(),
      get<_i205.SupplierNeedsSupportScreen>(),
      get<_i203.SupplierAdsScreen>()));
  gh.factory<_i213.MyApp>(() => _i213.MyApp(
      ...
      get<_i183.ChatModule>(),
      get<_i154.SettingsModule>(),
      get<_i189.MainModule>(),
      get<_i211.StoresModule>(),
      get<_i182.CategoriesModule>(),
      get<_i210.CompanyModule>(),
      get<_i208.BranchesModule>(),
      get<_i190.NoticeModule>(),
      get<_i209.CaptainsModule>(),
      get<_i196.PaymentsModule>(),
      get<_i204.SupplierCategoriesModule>(),
      get<_i212.SupplierModule>(),
      get<_i181.CarsModule>(),
      get<_i113.BidOrderModule>(),
      get<_i195.OrdersModule>(),
      get<_i202.SubscriptionsModule>()));
  gh.singleton<_i214.GlobalStateManager>(_i214.GlobalStateManager());
  return get;
}
