...
class BranchesListService {
  ...
  BranchesListService(this._manager);

  Future<DataModel> getBranches(String id) async {
    BranchListResponse? response = await _manager.getBranches(id);
  ...
  Future<DataModel> createBranch(CreateListBranchesRequest request) async {
