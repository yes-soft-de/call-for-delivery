...
class PackagesModel extends DataModel {
  ...
  PackagesModel({required this.id,required this.name,required this.note,required this.city,required this.status,
      required this.cost,required this.carCount,required this.orderCount,required this.expired });
