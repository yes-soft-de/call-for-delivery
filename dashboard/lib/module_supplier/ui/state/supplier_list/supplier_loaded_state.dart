...
class SupplierLoadedState extends States {
  final SuppliersScreenState screenState;
  final String? error;
  final bool empty;
  final List<InActiveModel>? model;

  SupplierLoadedState(this.screenState, this.model,
        ...
        Flexible(
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              if (!element.supplierName.contains(search ?? '') &&
                  search != null) return SizedBox();
              return Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () {
                    Navigator.of(context).pushNamed(
                        SupplierRoutes.SUPPLIER_PROFILE,
