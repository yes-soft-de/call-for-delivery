...
class CustomC4DFormField extends StatefulWidget {
  final double? height;
  ...
  final int? maxLength;
  @override
  _CustomC4DFormFieldState createState() => _CustomC4DFormFieldState();

  const CustomC4DFormField(
      {this.height,
...
class _CustomC4DFormFieldState extends State<CustomC4DFormField> {
