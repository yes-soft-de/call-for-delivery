...
class ActorCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ResponsiveLayout(
      mobileBody: ActorCardMobile(actor: actor),
      desktopBody: ActorCardDesktop(actor: actor),
    );
  }
}

class ActorCardMobile extends StatelessWidget {
  final StatisticsActors actor;
  final Mode mode = Mode.lastTransaction;
  const ActorCardMobile({Key? key, required this.actor}) : super(key: key);
...
class ActorCardDesktop extends StatelessWidget {
  final StatisticsActors actor;
  final Mode mode = Mode.lastTransaction;
  const ActorCardDesktop({Key? key, required this.actor}) : super(key: key);
