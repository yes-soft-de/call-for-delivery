...
class InitAccountStateManager {
  ...
  InitAccountStateManager(this._profileService, this._authService,
      this._uploadService, this._categoryService);
  void createProfile(ProfileRequest request, InitAccountScreenState screenState,
    ...
    _profileService.createStoreProfile(request).then((value) {
      if (value.hasError) {
        _stateSubject
            .add(InitAccountStateProfileLoaded(screenState, categories));
  ...
  void getCategories(InitAccountScreenState screenState) {
