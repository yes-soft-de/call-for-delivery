...
class AddOfferLoadedState extends States {
  ...
  final GlobalKey<FormState> _offerKey = GlobalKey<FormState>();
          ...
          children: [
            ...
            Padding(
              ...
              child: CustomFormField(
                ...
                hintText: S.of(context).transportationCount,
                numbers: true,
...
//                    });
        ...
        visible: true,
        onTap: (){
          if(_offerKey.currentState?.validate() == true && screenState.selectedCardModel != null && screenState.offerTime != null)
          screenState.addOffer(_priceController.text , _countController.text);
          else {
            CustomFlushBarHelper.createError(
                title: S.current.warnning, message: S.of(context).pleaseCompleteTheForm)
                .show(context);
          }
        },
      ),
