        ...
        child: Container(
          decoration: new BoxDecoration(
            border: BorderDirectional(
              start:
                  BorderSide(width: 5, color:OfferStatusHelper.getOfferStatusColor(model.priceOfferStatus)),
            ),
          ),
          child: ListTile(
...
//                backgroundColor: Colors.transparent,
            ...
            title: Column(
              children: [
                Row(
                  children: [
                    Text(S.of(context).price + ': ',style: TextStyle(fontWeight: FontWeight.bold),),
                    Text(model.priceOfferValue.toString() + ' '+S.of(context).sar),
                  ],
                ),
                Row(
                  children: [
                    Text(S.of(context).deadLine + ': ',style: TextStyle(fontWeight: FontWeight.bold),),
