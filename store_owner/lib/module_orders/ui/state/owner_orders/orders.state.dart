                  ...
                  return Container(
                    ...
                    child: GestureDetector(
                      ...
                      child: OrderCard(
                        ...
                        active:
                            orders[index].status != OrderStatusEnum.FINISHED,
                      ),
                    ),
                  );
                }),
  ...
  Future<List<OrderModel>> sortLocations() async {
    ...
    orders.sort((a, b) {
      return (distance.as(LengthUnit.Kilometer,
                  LatLng(a.toOnMap.latitude, a.toOnMap.longitude), myPos) -
              distance.as(LengthUnit.Kilometer,
                  LatLng(b.toOnMap.latitude, b.toOnMap.longitude), myPos))
          .toInt();
    });
    return orders;
  }
