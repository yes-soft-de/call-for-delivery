...
import '../module_about/about_module.dart' as _i74;
...
import '../module_branches/branches_module.dart' as _i89;
...
import '../module_my_notifications/manager/my_notifications_manager.dart'
    as _i47;
import '../module_my_notifications/my_notifications_module.dart' as _i81;
...
import '../module_orders/orders_module.dart' as _i94;
...
import '../module_orders/state_manager/owner_orders/owner_orders.state_manager.dart'
    as _i68;
import '../module_orders/ui/screens/new_order/new_order_screen.dart' as _i91;
import '../module_orders/ui/screens/order_details/order_details_screen.dart'
    as _i92;
import '../module_orders/ui/screens/order_logs_screen.dart' as _i93;
import '../module_orders/ui/screens/orders/owner_orders_screen.dart' as _i85;
import '../module_profile/manager/profile/profile.manager.dart' as _i50;
import '../module_profile/module_profile.dart' as _i86;
...
import '../module_profile/ui/screen/init_account_screen.dart' as _i78;
...
import '../module_subscription/state_manager/subscription_balance_state_manager.dart'
    as _i87;
import '../module_subscription/subscriptions_module.dart' as _i96;
...
import '../module_upload/service/image_upload/image_upload_service.dart'
    as _i28;
import '../utils/global/global_state_manager.dart' as _i98;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i49.MyNotificationsStateManager>(() =>
      _i49.MyNotificationsStateManager(
  ...
  gh.factory<_i66.MyNotificationsScreen>(() =>
      _i66.MyNotificationsScreen(get<_i49.MyNotificationsStateManager>()));
  ...
  gh.factory<_i74.AboutModule>(
      () => _i74.AboutModule(get<_i57.AboutScreenStateManager>()));
  ...
  gh.factory<_i77.ChatModule>(
      () => _i77.ChatModule(get<_i62.ChatPage>(), get<_i24.AuthService>()));
  gh.factory<_i78.InitAccountScreen>(
      () => _i78.InitAccountScreen(get<_i64.InitAccountStateManager>()));
  gh.factory<_i79.InitBranchesScreen>(
      () => _i79.InitBranchesScreen(get<_i65.InitBranchesStateManager>()));
  gh.factory<_i80.InitSubscriptionStateManager>(() =>
      _i80.InitSubscriptionStateManager(
          get<_i71.SubscriptionService>(),
          get<_i51.ProfileService>(),
          get<_i24.AuthService>(),
          get<_i28.ImageUploadService>()));
  gh.factory<_i81.MyNotificationsModule>(() => _i81.MyNotificationsModule(
      get<_i66.MyNotificationsScreen>(), get<_i73.UpdateScreen>()));
  gh.factory<_i82.NewOrderStateManager>(
      () => _i82.NewOrderStateManager(get<_i67.OrdersService>()));
  gh.factory<_i83.OrderLogsStateManager>(
      () => _i83.OrderLogsStateManager(get<_i67.OrdersService>()));
  gh.factory<_i84.OrderStatusStateManager>(() => _i84.OrderStatusStateManager(
      get<_i67.OrdersService>(), get<_i24.AuthService>()));
  gh.factory<_i85.OwnerOrdersScreen>(() => _i85.OwnerOrdersScreen(
      get<_i68.OwnerOrdersStateManager>(), get<_i82.NewOrderStateManager>()));
  gh.factory<_i86.ProfileModule>(() => _i86.ProfileModule(
      get<_i69.ProfileScreen>(),
      get<_i78.InitAccountScreen>(),
      get<_i75.AccountBalanceScreen>()));
  gh.factory<_i87.SubscriptionBalanceStateManager>(() =>
      _i87.SubscriptionBalanceStateManager(
          get<_i71.SubscriptionService>(),
          get<_i51.ProfileService>(),
          get<_i24.AuthService>(),
          get<_i28.ImageUploadService>()));
  gh.factory<_i88.UpdateBranchScreen>(
      () => _i88.UpdateBranchScreen(get<_i72.UpdateBranchStateManager>()));
  gh.factory<_i89.BranchesModule>(() => _i89.BranchesModule(
      get<_i76.BranchesListScreen>(),
      get<_i88.UpdateBranchScreen>(),
      get<_i79.InitBranchesScreen>()));
  gh.factory<_i90.InitSubscriptionScreen>(() =>
      _i90.InitSubscriptionScreen(get<_i80.InitSubscriptionStateManager>()));
  gh.factory<_i91.NewOrderScreen>(
      () => _i91.NewOrderScreen(get<_i82.NewOrderStateManager>()));
  gh.factory<_i92.OrderDetailsScreen>(
      () => _i92.OrderDetailsScreen(get<_i84.OrderStatusStateManager>()));
  gh.factory<_i93.OrderLogsScreen>(
      () => _i93.OrderLogsScreen(get<_i83.OrderLogsStateManager>()));
  gh.factory<_i94.OrdersModule>(() => _i94.OrdersModule(
      get<_i91.NewOrderScreen>(),
      get<_i92.OrderDetailsScreen>(),
      get<_i85.OwnerOrdersScreen>(),
      get<_i93.OrderLogsScreen>()));
  gh.factory<_i95.SubscriptionBalanceScreen>(() =>
      _i95.SubscriptionBalanceScreen(
          get<_i87.SubscriptionBalanceStateManager>()));
  gh.factory<_i96.SubscriptionsModule>(() => _i96.SubscriptionsModule(
      get<_i90.InitSubscriptionScreen>(),
      get<_i95.SubscriptionBalanceScreen>()));
  gh.factory<_i97.MyApp>(() => _i97.MyApp(
      get<_i94.OrdersModule>(),
      get<_i18.AppThemeDataService>(),
      get<_i10.LocalizationService>(),
      get<_i44.FireNotificationService>(),
      ...
      get<_i74.AboutModule>(),
      get<_i86.ProfileModule>(),
      get<_i89.BranchesModule>(),
      get<_i96.SubscriptionsModule>(),
      get<_i81.MyNotificationsModule>()));
  gh.singleton<_i98.GlobalStateManager>(_i98.GlobalStateManager());
  return get;
}
