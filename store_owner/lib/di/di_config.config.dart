...
import '../module_about/about_module.dart' as _i121;
...
import '../module_about/state_manager/company_info_state_manager.dart' as _i93;
...
import '../module_bidorder/bid_orders_module.dart' as _i90;
...
import '../module_bidorder/ui/screens/add_bidorder_screen.dart' as _i88;
...
import '../module_bidorder/ui/screens/bidorder_details/order_offer_details_screen.dart'
    as _i78;
import '../module_bidorder/ui/screens/bidorder_logs_screen.dart' as _i89;
...
import '../module_my_notifications/manager/my_notifications_manager.dart'
    as _i52;
import '../module_my_notifications/my_notifications_module.dart' as _i122;
...
import '../module_orders/orders_module.dart' as _i117;
...
import '../module_orders/state_manager/owner_orders/owner_orders.state_manager.dart'
    as _i80;
import '../module_orders/ui/screens/new_order/new_order_screen.dart' as _i113;
import '../module_orders/ui/screens/new_order_link.dart' as _i112;
import '../module_orders/ui/screens/order_details/order_details_screen.dart'
    as _i114;
import '../module_orders/ui/screens/order_logs_screen.dart' as _i115;
import '../module_orders/ui/screens/order_time_line_screen.dart' as _i116;
import '../module_orders/ui/screens/orders/owner_orders_screen.dart' as _i103;
import '../module_profile/manager/profile/profile.manager.dart' as _i57;
import '../module_profile/module_profile.dart' as _i104;
...
import '../module_profile/state_manager/init_account.state_manager.dart'
    as _i74;
import '../module_profile/ui/screen/account_balance_screen.dart' as _i87;
import '../module_profile/ui/screen/edit_profile/edit_profile.dart' as _i81;
import '../module_profile/ui/screen/init_account_screen.dart' as _i94;
...
import '../module_subscription/service/subscription_service.dart' as _i83;
...
import '../module_subscription/state_manager/subscription_balance_state_manager.dart'
    as _i106;
import '../module_subscription/subscriptions_module.dart' as _i120;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i83.SubscriptionService>(
      () => _i83.SubscriptionService(get<_i62.SubscriptionsManager>()));
  gh.factory<_i84.UpdateBranchStateManager>(
      () => _i84.UpdateBranchStateManager(get<_i70.BranchesListService>()));
  gh.factory<_i85.UpdateScreen>(
      () => _i85.UpdateScreen(get<_i63.UpdatesStateManager>()));
  gh.factory<_i86.AboutScreen>(
      () => _i86.AboutScreen(get<_i64.AboutScreenStateManager>()));
  gh.factory<_i87.AccountBalanceScreen>(
      () => _i87.AccountBalanceScreen(get<_i65.AccountBalanceStateManager>()));
  gh.factory<_i88.AddBidOrderScreen>(
      () => _i88.AddBidOrderScreen(get<_i66.AddBidOrderStateManager>()));
  gh.factory<_i89.BidOrderLogsScreen>(
      () => _i89.BidOrderLogsScreen(get<_i69.BidOrderLogsStateManager>()));
  gh.factory<_i90.BidOrdersModule>(() => _i90.BidOrdersModule(
      get<_i76.OpenBidOrderScreen>(),
      get<_i88.AddBidOrderScreen>(),
      get<_i78.OrderOfferDetailsScreen>(),
      get<_i89.BidOrderLogsScreen>(),
      get<_i68.BidOrderDetailsScreen>()));
  gh.factory<_i91.BranchesListScreen>(
      () => _i91.BranchesListScreen(get<_i71.BranchesListStateManager>()));
  gh.factory<_i92.ChatModule>(() =>
      _i92.ChatModule(get<_i72.ChatPage>(), get<_i77.OrderChatRoomsScreen>()));
  gh.factory<_i93.CompanyInfoStateManager>(() => _i93.CompanyInfoStateManager(
      get<_i79.OrdersService>(),
      get<_i25.AuthService>(),
      get<_i58.ProfileService>()));
  gh.factory<_i94.InitAccountScreen>(
      () => _i94.InitAccountScreen(get<_i74.InitAccountStateManager>()));
  gh.factory<_i95.InitBranchesScreen>(
      () => _i95.InitBranchesScreen(get<_i75.InitBranchesStateManager>()));
  gh.factory<_i96.InitSubscriptionStateManager>(() =>
      _i96.InitSubscriptionStateManager(
          get<_i83.SubscriptionService>(),
          get<_i58.ProfileService>(),
          get<_i25.AuthService>(),
          get<_i30.ImageUploadService>()));
  gh.factory<_i97.MyNotificationsStateManager>(() =>
      _i97.MyNotificationsStateManager(get<_i53.MyNotificationsService>(),
          get<_i79.OrdersService>(), get<_i25.AuthService>()));
  gh.factory<_i98.NewOrderLinkStateManager>(
      () => _i98.NewOrderLinkStateManager(get<_i79.OrdersService>()));
  gh.factory<_i99.NewOrderStateManager>(
      () => _i99.NewOrderStateManager(get<_i79.OrdersService>()));
  gh.factory<_i100.OrderLogsStateManager>(
      () => _i100.OrderLogsStateManager(get<_i79.OrdersService>()));
  ...
  gh.factory<_i102.OrderTimeLineStateManager>(() =>
      _i102.OrderTimeLineStateManager(
          get<_i79.OrdersService>(), get<_i25.AuthService>()));
  gh.factory<_i103.OwnerOrdersScreen>(() => _i103.OwnerOrdersScreen(
      get<_i80.OwnerOrdersStateManager>(), get<_i99.NewOrderStateManager>()));
  gh.factory<_i104.ProfileModule>(() => _i104.ProfileModule(
      get<_i81.ProfileScreen>(),
      get<_i94.InitAccountScreen>(),
      get<_i87.AccountBalanceScreen>()));
  gh.factory<_i105.StoreSubscriptionsFinanceStateManager>(() =>
      _i105.StoreSubscriptionsFinanceStateManager(
          get<_i83.SubscriptionService>()));
  gh.factory<_i106.SubscriptionBalanceStateManager>(() =>
      _i106.SubscriptionBalanceStateManager(
          get<_i83.SubscriptionService>(),
          get<_i58.ProfileService>(),
          get<_i25.AuthService>(),
          get<_i30.ImageUploadService>()));
  gh.factory<_i107.UpdateBranchScreen>(
      () => _i107.UpdateBranchScreen(get<_i84.UpdateBranchStateManager>()));
  ...
  gh.factory<_i109.CompanyInfoScreen>(
      () => _i109.CompanyInfoScreen(get<_i93.CompanyInfoStateManager>()));
  gh.factory<_i110.InitSubscriptionScreen>(() =>
      _i110.InitSubscriptionScreen(get<_i96.InitSubscriptionStateManager>()));
  gh.factory<_i111.MyNotificationsScreen>(() =>
      _i111.MyNotificationsScreen(get<_i97.MyNotificationsStateManager>()));
  gh.factory<_i112.NewOrderLinkScreen>(
      () => _i112.NewOrderLinkScreen(get<_i98.NewOrderLinkStateManager>()));
  gh.factory<_i113.NewOrderScreen>(
      () => _i113.NewOrderScreen(get<_i99.NewOrderStateManager>()));
  gh.factory<_i114.OrderDetailsScreen>(
      () => _i114.OrderDetailsScreen(get<_i101.OrderStatusStateManager>()));
  gh.factory<_i115.OrderLogsScreen>(
      () => _i115.OrderLogsScreen(get<_i100.OrderLogsStateManager>()));
  gh.factory<_i116.OrderTimeLineScreen>(
      () => _i116.OrderTimeLineScreen(get<_i102.OrderTimeLineStateManager>()));
  gh.factory<_i117.OrdersModule>(() => _i117.OrdersModule(
      get<_i113.NewOrderScreen>(),
      get<_i114.OrderDetailsScreen>(),
      get<_i103.OwnerOrdersScreen>(),
      get<_i116.OrderTimeLineScreen>(),
      get<_i115.OrderLogsScreen>()));
  gh.factory<_i118.StoreSubscriptionsFinanceScreen>(() =>
      _i118.StoreSubscriptionsFinanceScreen(
          get<_i105.StoreSubscriptionsFinanceStateManager>()));
  gh.factory<_i119.SubscriptionBalanceScreen>(() =>
      _i119.SubscriptionBalanceScreen(
          get<_i106.SubscriptionBalanceStateManager>()));
  gh.factory<_i120.SubscriptionsModule>(() => _i120.SubscriptionsModule(
      get<_i110.InitSubscriptionScreen>(),
      get<_i119.SubscriptionBalanceScreen>(),
      get<_i118.StoreSubscriptionsFinanceScreen>(),
      get<_i15.StoreSubscriptionsFinanceDetailsScreen>()));
  gh.factory<_i121.AboutModule>(() => _i121.AboutModule(
      get<_i86.AboutScreen>(), get<_i109.CompanyInfoScreen>()));
  gh.factory<_i122.MyNotificationsModule>(() => _i122.MyNotificationsModule(
      get<_i111.MyNotificationsScreen>(), get<_i85.UpdateScreen>()));
  gh.factory<_i123.MyApp>(() => _i123.MyApp(
      get<_i117.OrdersModule>(),
      get<_i19.AppThemeDataService>(),
      get<_i10.LocalizationService>(),
      get<_i49.FireNotificationService>(),
      ...
      get<_i121.AboutModule>(),
      get<_i104.ProfileModule>(),
      get<_i108.BranchesModule>(),
      get<_i120.SubscriptionsModule>(),
      get<_i122.MyNotificationsModule>(),
      get<_i90.BidOrdersModule>()));
