...
import '../module_about/about_module.dart' as _i73;
...
import '../module_my_notifications/manager/my_notifications_manager.dart'
    as _i46;
import '../module_my_notifications/my_notifications_module.dart' as _i80;
...
import '../module_my_notifications/ui/screen/my_notifications_screen.dart'
    as _i65;
import '../module_my_notifications/ui/screen/update_screen.dart' as _i72;
...
import '../module_orders/repository/order_repository/order_repository.dart'
    as _i31;
import '../module_orders/service/orders/orders.service.dart' as _i66;
...
import '../module_orders/state_manager/owner_orders/owner_orders.state_manager.dart'
    as _i67;
import '../module_orders/ui/screens/new_order/new_order_screen.dart' as _i90;
import '../module_orders/ui/screens/order_details/order_details_screen.dart'
    as _i91;
import '../module_orders/ui/screens/order_logs_screen.dart' as _i92;
...
import '../module_profile/state_manager/init_account.state_manager.dart'
    as _i63;
import '../module_profile/ui/screen/account_balance_screen.dart' as _i74;
...
import '../module_subscription/service/subscription_service.dart' as _i70;
...
import '../module_subscription/state_manager/subscription_balance_state_manager.dart'
    as _i86;
import '../module_subscription/subscriptions_module.dart' as _i95;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i65.MyNotificationsScreen>(() =>
      _i65.MyNotificationsScreen(get<_i48.MyNotificationsStateManager>()));
  gh.factory<_i66.OrdersService>(() => _i66.OrdersService(
      get<_i32.OrdersManager>(), get<_i50.ProfileService>()));
  gh.factory<_i67.OwnerOrdersStateManager>(() => _i67.OwnerOrdersStateManager(
      get<_i66.OrdersService>(),
      get<_i23.AuthService>(),
      get<_i50.ProfileService>()));
  gh.factory<_i68.ProfileScreen>(
      () => _i68.ProfileScreen(get<_i62.EditProfileStateManager>()));
  gh.factory<_i69.SettingsModule>(() => _i69.SettingsModule(
      get<_i52.SettingsScreen>(), get<_i19.ChooseLocalScreen>()));
  gh.factory<_i70.SubscriptionService>(
      () => _i70.SubscriptionService(get<_i54.SubscriptionsManager>()));
  gh.factory<_i71.UpdateBranchStateManager>(
      () => _i71.UpdateBranchStateManager(get<_i59.BranchesListService>()));
  gh.factory<_i72.UpdateScreen>(
      () => _i72.UpdateScreen(get<_i55.UpdatesStateManager>()));
  gh.factory<_i73.AboutModule>(
      () => _i73.AboutModule(get<_i56.AboutScreenStateManager>()));
  gh.factory<_i74.AccountBalanceScreen>(
      () => _i74.AccountBalanceScreen(get<_i57.AccountBalanceStateManager>()));
  gh.factory<_i75.BranchesListScreen>(
      () => _i75.BranchesListScreen(get<_i60.BranchesListStateManager>()));
  gh.factory<_i76.ChatModule>(
      () => _i76.ChatModule(get<_i61.ChatPage>(), get<_i23.AuthService>()));
  ...
  gh.factory<_i79.InitSubscriptionStateManager>(() =>
      _i79.InitSubscriptionStateManager(
          get<_i70.SubscriptionService>(),
          get<_i50.ProfileService>(),
          get<_i23.AuthService>(),
          get<_i27.ImageUploadService>()));
  gh.factory<_i80.MyNotificationsModule>(() => _i80.MyNotificationsModule(
      get<_i65.MyNotificationsScreen>(), get<_i72.UpdateScreen>()));
  gh.factory<_i81.NewOrderStateManager>(
      () => _i81.NewOrderStateManager(get<_i66.OrdersService>()));
  gh.factory<_i82.OrderLogsStateManager>(
      () => _i82.OrderLogsStateManager(get<_i66.OrdersService>()));
  gh.factory<_i83.OrderStatusStateManager>(() => _i83.OrderStatusStateManager(
      get<_i66.OrdersService>(), get<_i23.AuthService>()));
  gh.factory<_i84.OwnerOrdersScreen>(() => _i84.OwnerOrdersScreen(
      get<_i67.OwnerOrdersStateManager>(), get<_i81.NewOrderStateManager>()));
  gh.factory<_i85.ProfileModule>(() => _i85.ProfileModule(
      get<_i68.ProfileScreen>(),
      get<_i77.InitAccountScreen>(),
      get<_i74.AccountBalanceScreen>()));
  ...
  gh.factory<_i87.UpdateBranchScreen>(
      () => _i87.UpdateBranchScreen(get<_i71.UpdateBranchStateManager>()));
  gh.factory<_i88.BranchesModule>(() => _i88.BranchesModule(
      get<_i75.BranchesListScreen>(),
      get<_i87.UpdateBranchScreen>(),
      get<_i78.InitBranchesScreen>()));
  gh.factory<_i89.InitSubscriptionScreen>(() =>
      _i89.InitSubscriptionScreen(get<_i79.InitSubscriptionStateManager>()));
  gh.factory<_i90.NewOrderScreen>(
      () => _i90.NewOrderScreen(get<_i81.NewOrderStateManager>()));
  gh.factory<_i91.OrderDetailsScreen>(
      () => _i91.OrderDetailsScreen(get<_i83.OrderStatusStateManager>()));
  gh.factory<_i92.OrderLogsScreen>(
      () => _i92.OrderLogsScreen(get<_i82.OrderLogsStateManager>()));
  gh.factory<_i93.OrdersModule>(() => _i93.OrdersModule(
      get<_i90.NewOrderScreen>(),
      get<_i91.OrderDetailsScreen>(),
      get<_i84.OwnerOrdersScreen>(),
      get<_i92.OrderLogsScreen>()));
  gh.factory<_i94.SubscriptionBalanceScreen>(() =>
      _i94.SubscriptionBalanceScreen(
          get<_i86.SubscriptionBalanceStateManager>()));
  gh.factory<_i95.SubscriptionsModule>(() => _i95.SubscriptionsModule(
      get<_i89.InitSubscriptionScreen>(),
      get<_i94.SubscriptionBalanceScreen>()));
  gh.factory<_i96.MyApp>(() => _i96.MyApp(
      ...
      get<_i73.AboutModule>(),
      get<_i85.ProfileModule>(),
      get<_i88.BranchesModule>(),
      get<_i95.SubscriptionsModule>(),
      get<_i80.MyNotificationsModule>()));
