...
class BidOrderCard extends StatelessWidget {
  ...
  BidOrderCard(
      {required this.model, required this.isOpen, required this.deleteOrder});
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        isOpen
            ? Navigator.pushNamed(context, BidOrdersRoutes.ORDER_OFFERS_SCREEN,
                arguments: model.bidOrderId)
            : Navigator.pushNamed(
                context, BidOrdersRoutes.BID_ORDER_STATUS_SCREEN,
                arguments: model.id);
      },
      child: Padding(
        ...
        child: Container(
          foregroundDecoration: RotatedCornerDecoration(
            ...
            textSpan: TextSpan(
                text: isOpen ? S.of(context).open : S.of(context).close),
                    ...
                    Row(
                      ...
                      children: [
                        verticalTile(context,
                            ...
                            subtitle: model.branchName),
                        verticalTile(context,
                            title: S.current.paymentMethod,
                            subtitle: model.payment == 'cash'
                                ? S.of(context).cash
                                : S.current.card),
                        verticalTile(context,
