...
class Urls {
  ...
  static const CAPTAIN_PROFILE_API = '$BASE_API/v1/captain/captainprofilebyid';
  ...
  static const CHECK_USER_ROLE = '$BASE_API/v1/user/checkUserType';
  ...
  static const GET_CAPTAIN_FINANCE_BY_ORDER =
      '$DOMAIN/v1/captainfinancialsystemaccordingnorder/captainfinancialsystemaccordingonorder';
  static const GET_CAPTAIN_FINANCE_BY_HOURS =
      '$DOMAIN/v1/captainfinancialsystemaccordingtocountofhours/captainfinancialsystemaccordingtocountofhours';
  static const GET_CAPTAIN_FINANCE_BY_COUNT_ORDER =
      '$DOMAIN/v1/captainfinancialsystemaccordingntocountoforders/captainfinancialsystemaccordingtocountoforders';
