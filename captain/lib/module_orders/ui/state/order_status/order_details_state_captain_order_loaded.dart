...
import 'package:c4d/module_orders/ui/widgets/order_status_widget/private_order.dart';
import 'package:c4d/module_orders/ui/widgets/order_status_widget/products.dart';
import 'package:c4d/module_orders/ui/widgets/order_status_widget/send_it_for_me.dart';
...
class OrderDetailsStateCaptainOrderLoaded extends OrderDetailsState {
  ...
  OrderDetailsStateCaptainOrderLoaded(
    ...
    if (orderInfo.state == OrderStatusEnum.IN_STORE &&
