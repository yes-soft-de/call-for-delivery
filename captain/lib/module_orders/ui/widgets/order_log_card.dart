...
class OrderLogCard extends StatelessWidget {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  verticalTile(
                    context,
                    title: S.current.theProfits,
                    subtitle: '$profit ${S.current.sar}',
                  ),
                  Icon(
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  dotedDivider(context),
                  Text(
                    '${branchToDestination ?? S.current.unknown} ${S.current.km}',
                    style: const TextStyle(
                        fontSize: 12,
                        fontWeight: FontWeight.bold,
                        color: Colors.white),
                ...
                Visibility(
                  ...
                  child: Visibility(
                    ...
                    replacement: verticalTile(context,
                        ...
                        subtitle:
                            '$orderCost ${S.current.sar} | ${S.current.cash}'),
                ...
                Visibility(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(12.0),
                        child: Text(
                          '${S.current.netProfit} $captainProfit ${S.current.sar}',
