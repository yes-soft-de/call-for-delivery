...
import '../module_about/about_module.dart' as _i108;
...
import '../module_chat/chat_module.dart' as _i99;
...
import '../module_my_notifications/manager/my_notifications_manager.dart'
    as _i57;
import '../module_my_notifications/my_notifications_module.dart' as _i102;
...
import '../module_orders/orders_module.dart' as _i104;
...
import '../module_orders/ui/screens/terms/terms.dart' as _i92;
import '../module_plan/manager/captain_balance_manager.dart' as _i47;
import '../module_plan/plan_module.dart' as _i105;
...
import '../module_plan/state_manager/plan_screen_state_manager.dart' as _i90;
import '../module_plan/ui/screen/account_balance_screen.dart' as _i95;
import '../module_plan/ui/screen/captain_financial_details_screen.dart' as _i6;
import '../module_plan/ui/screen/captain_financial_dues_screen.dart' as _i98;
import '../module_plan/ui/screen/daily_payments_screen.dart' as _i82;
import '../module_plan/ui/screen/my_profits_screen.dart' as _i103;
import '../module_plan/ui/screen/plan_screen.dart' as _i106;
...
import '../module_profile/ui/screen/activity_screen/activity_screen.dart'
    as _i97;
import '../module_profile/ui/screen/edit_profile/edit_profile.dart' as _i100;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i90.PlanScreenStateManager>(
      () => _i90.PlanScreenStateManager(gh<_i63.PlanService>()));
  gh.factory<_i91.SettingsModule>(() => _i91.SettingsModule(
        gh<_i67.SettingsScreen>(),
        gh<_i24.ChooseLocalScreen>(),
        gh<_i17.PrivecyPolicy>(),
        gh<_i18.TermsOfUse>(),
      ));
  gh.factory<_i92.TermsScreen>(
      () => _i92.TermsScreen(gh<_i70.TermsStateManager>()));
  gh.factory<_i93.UpdateScreen>(
      () => _i93.UpdateScreen(gh<_i71.UpdatesStateManager>()));
  gh.factory<_i94.AboutScreen>(
      () => _i94.AboutScreen(gh<_i72.AboutScreenStateManager>()));
  gh.factory<_i95.AccountBalanceScreen>(
      () => _i95.AccountBalanceScreen(gh<_i74.AccountBalanceStateManager>()));
  gh.factory<_i96.AccountBalanceScreen>(
      () => _i96.AccountBalanceScreen(gh<_i73.AccountBalanceStateManager>()));
  gh.factory<_i97.ActivityScreen>(
      () => _i97.ActivityScreen(gh<_i75.ActivityStateManager>()));
  gh.factory<_i98.CaptainFinancialDuesScreen>(() =>
      _i98.CaptainFinancialDuesScreen(
          gh<_i77.CaptainFinancialDuesStateManager>()));
  gh.factory<_i99.ChatModule>(() => _i99.ChatModule(
        gh<_i80.ChatPage>(),
        gh<_i28.AuthService>(),
      ));
  gh.factory<_i100.EditProfileScreen>(
      () => _i100.EditProfileScreen(gh<_i83.EditProfileStateManager>()));
  gh.factory<_i101.InitAccountModule>(
      () => _i101.InitAccountModule(gh<_i84.InitAccountScreen>()));
  gh.factory<_i102.MyNotificationsModule>(() => _i102.MyNotificationsModule(
        gh<_i85.MyNotificationsScreen>(),
        gh<_i93.UpdateScreen>(),
      ));
  gh.factory<_i103.MyProfitsScreen>(
      () => _i103.MyProfitsScreen(gh<_i86.MyProfitsStateManager>()));
  gh.factory<_i104.OrdersModule>(() => _i104.OrdersModule(
  ...
  gh.factory<_i105.PlanModule>(() => _i105.PlanModule(
        gh<_i95.AccountBalanceScreen>(),
        gh<_i6.CaptainFinancialDuesDetailsScreen>(),
        gh<_i98.CaptainFinancialDuesScreen>(),
        gh<_i82.DailyPaymentsScreen>(),
        gh<_i103.MyProfitsScreen>(),
      ));
  gh.factory<_i106.PlanScreen>(
      () => _i106.PlanScreen(gh<_i90.PlanScreenStateManager>()));
  gh.factory<_i107.ProfileModule>(() => _i107.ProfileModule(
        gh<_i97.ActivityScreen>(),
        gh<_i100.EditProfileScreen>(),
        gh<_i96.AccountBalanceScreen>(),
      ));
  gh.factory<_i108.AboutModule>(
      () => _i108.AboutModule(gh<_i94.AboutScreen>()));
  gh.factory<_i109.MyApp>(() => _i109.MyApp(
        ...
        gh<_i99.ChatModule>(),
        gh<_i91.SettingsModule>(),
        gh<_i108.AboutModule>(),
        gh<_i101.InitAccountModule>(),
        gh<_i104.OrdersModule>(),
        gh<_i105.PlanModule>(),
        gh<_i107.ProfileModule>(),
        gh<_i102.MyNotificationsModule>(),
      ));
  return getIt;
}
