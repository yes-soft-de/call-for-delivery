...
import '../../module_profile/response/daily_finance_response/payments.dart';
...
class CaptainDailyFinanceModel extends DataModel {
  ...
  List<PaymentModel> getPayments(List<Payments> p) {
    List<PaymentModel> payments = [];
    for (var pp in p) {
      payments.add(PaymentModel(
          ...
          id: pp.id ?? -1,
          note: pp.note,
          paymentDate: DateHelper.convert(pp.date?.timestamp)));
    }
    return payments;
  }
}
