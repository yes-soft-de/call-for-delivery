...
class SubscriptionFirebaseNotificationService
{
    ...
    public function sendFirebaseNotificationToAdmin(string $subscriptionActionDescription, string $storeName): array
    {
        $devicesToken = [];
        ...
        if (count($adminsTokens) > 0) {
            ...
            $msgContent = $subscriptionActionDescription.$storeName;
