...
class AdminCaptainFinancialSystemTwoBalanceDetailService
{
    ...
    public function getBalanceDetailWithSystemTwo(array $financialSystemDetail, int $captainId, float $sumPayments): AdminCaptainFinancialSystemAccordingToCountOfHoursBalanceDetailResponse
    {
