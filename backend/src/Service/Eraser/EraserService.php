...
class EraserService
{
    ...
    public function __construct(EraserManager $eraserManager, ParameterBagInterface $param, OrderService $orderService, CaptainAmountFromOrderCashService $captainAmountFromOrderCashService,
                                ...
                                OrderChatRoomService $orderChatRoomService, CaptainService $captainService, UserService $userService, AutoMapping $autoMapping)
    {
