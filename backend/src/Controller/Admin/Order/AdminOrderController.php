...
class AdminOrderController extends BaseController
{
     ...
     * @Route("createtestorder", name="createTestingOrderByAdmin", methods={"POST"})
     * @IsGranted("ROLE_ADMIN")
     * @param Request $request
     * @return JsonResponse
     *
     ...
     * @Security(name="Bearer")
     */
    public function createTestingOrderByAdmin(Request $request): JsonResponse
    {
        $data = json_decode($request->getContent(), true);
        ...
        $result = $this->adminOrderService->createTestingOrderByAdmin($request, $this->getUserId());
