...
final class OrderResultConstant
{
    ...
    const ORDER_PAID_TO_PROVIDER_WRONG_ANSWER_CONST = 248;

    const CAPTAIN_HAS_ORDER_WITH_ON_WAY_TO_PICK_ORDER_STATUS_CONST = 260;

    const CAPTAIN_HAS_NOT_ORDER_WITH_ON_WAY_TO_PICK_ORDER_STATUS_CONST = 261;
}
