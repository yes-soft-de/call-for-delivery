...
final class OrderLogActionTypeConstant
{
    ...
    const ORDER_CANCELLED_ONLY_IN_STREETLINE_BY_ADMIN_ACTION_CONST = 45;

    const ORDER_CANCELLED_IN_STREETLINE_AND_IN_C4D_BY_ADMIN_ACTION_CONST = 46;

    const ORDER_DISTANCE_CONFLICT_CREATED_BY_CAPTAIN_ACTION_CONST = 47;
}
